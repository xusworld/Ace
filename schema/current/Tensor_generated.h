...
enum DATA_FORMAT {
  ...
  DATA_FORMAT_MAX = DATA_FORMAT_UNKNOWN
};

inline const DATA_FORMAT (&EnumValuesDATA_FORMAT())[5] {
  static const DATA_FORMAT values[] = {
    DATA_FORMAT_NCHW,
    DATA_FORMAT_NHWC,
    DATA_FORMAT_NC4HW4,
    DATA_FORMAT_NHWC4,
...
inline const char * const *EnumNamesDATA_FORMAT() {
...
inline const char *EnumNameDATA_FORMAT(DATA_FORMAT e) {
  if (e < DATA_FORMAT_NCHW || e > DATA_FORMAT_UNKNOWN) return "";
  const size_t index = static_cast<int>(e);
  return EnumNamesDATA_FORMAT()[index];
}
...
struct Blob FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  DATA_FORMAT dataFormat() const {
    return static_cast<DATA_FORMAT>(GetField<int8_t>(6, 0));
  }
...
struct BlobBuilder {
  ...
  void add_dataFormat(DATA_FORMAT dataFormat) {
...
inline flatbuffers::Offset<Blob> CreateBlob(
    ...
    DATA_FORMAT dataFormat = DATA_FORMAT_NCHW,
...
inline const flatbuffers::TypeTable *DATA_FORMATTypeTable() {
