...
#ifndef FLATBUFFERS_GENERATED_TENSOR_TARS_H_
#define FLATBUFFERS_GENERATED_TENSOR_TARS_H_
...
inline flatbuffers::Offset<NamedAttrList> CreateNamedAttrList(flatbuffers::FlatBufferBuilder &_fbb, const NamedAttrListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return tars::CreateNamedAttrList(
      _fbb,
      _name,
      _attr);
}
...
#endif  // FLATBUFFERS_GENERATED_TENSOR_TARS_H_
