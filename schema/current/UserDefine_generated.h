...
struct TensorConvertInfoT : public flatbuffers::NativeTable {
  ...
  DATA_FORMAT dest;
  TensorConvertInfoT()
      : source(DATA_FORMAT_NCHW),
        dest(DATA_FORMAT_NCHW) {
  }
};
...
struct TensorConvertInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  DATA_FORMAT source() const {
    return static_cast<DATA_FORMAT>(GetField<int8_t>(4, 0));
  }
  DATA_FORMAT dest() const {
...
struct TensorConvertInfoBuilder {
  ...
  void add_source(DATA_FORMAT source) {
    fbb_.AddElement<int8_t>(4, static_cast<int8_t>(source), 0);
  }
  void add_dest(DATA_FORMAT dest) {
...
inline flatbuffers::Offset<TensorConvertInfo> CreateTensorConvertInfo(
    ...
    DATA_FORMAT source = DATA_FORMAT_NCHW,
    DATA_FORMAT dest = DATA_FORMAT_NCHW) {
