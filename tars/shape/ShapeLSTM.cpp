...
class LSTMComputer : public SizeComputer {
  virtual bool onComputeSize(
    ...
    TensorUtils::getDescribe(Y)->dimensionFormat =
        TensorUtils::getDescribe(X)->dimensionFormat;
    TensorUtils::getDescribe(ht)->dimensionFormat =
        TensorUtils::getDescribe(X)->dimensionFormat;
    TensorUtils::getDescribe(ct)->dimensionFormat =
        TensorUtils::getDescribe(X)->dimensionFormat;
