...
bool AVX2Functions::init(int cpuFlags) {
  ...
  *gAVX2CoreInt8Functions = *MNNGetInt8CoreFunctions();
  ...
  if ((cpuFlags & libyuv::kCpuHasAVX512VNNI) ||
    ...
    memcpy(coreFunction->MNNPackedMatMulOC16Functions,
           _AVX512_MNNPackedMatMulOC16Functions,
           sizeof(tars::CoreFunctions::MNNPackedMatMulKernel) *
               AVX512_INPUT_TILE_MAX);
    memcpy(coreFunction->MNNPackedMatMulOC32Functions,
           _AVX512_MNNPackedMatMulOC32Functions,
           sizeof(tars::CoreFunctions::MNNPackedMatMulKernel) *
               AVX512_INPUT_TILE_MAX);
    memcpy(coreFunction->MNNPackedMatMulOC48Functions,
           _AVX512_MNNPackedMatMulOC48Functions,
           sizeof(tars::CoreFunctions::MNNPackedMatMulKernel) *
               AVX512_INPUT_TILE_MAX);
  }
#endif
...
CoreFunctions* AVX2Functions::get() { return gAVX2CoreFunctions; }
CoreInt8Functions* AVX2Functions::getInt8() { return gAVX2CoreInt8Functions; }
