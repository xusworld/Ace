...
Status CPUBinary::onResize(const std::vector<Tensor*>& inputs,
...
Status CPUBinary::onExecute(const std::vector<Tensor*>& inputs,
                            const std::vector<Tensor*>& outputs) {
  const int input0DataCount = ((CPUDevice*)backend())->getTensorSize(inputs[0]);
  const int input1DataCount = ((CPUDevice*)backend())->getTensorSize(inputs[1]);
  //    inputs[0]->printShape();
  //    inputs[1]->printShape();
  ...
  auto schedule = ((CPUDevice*)backend())->multiThreadDivide(mTotalSize);
  ...
  if (halide_type_float == input->getType().code) {
    inpBytes = static_cast<CPUDevice*>(backend())->functions()->bytes;
  }
  if (halide_type_float == output->getType().code) {
    outBytes = static_cast<CPUDevice*>(backend())->functions()->bytes;
  }
  auto precision = static_cast<CPUDevice*>(backend())->precisionMode();
...
MNNBinaryExecute CPUBinary::selectForInt(int type) {
  switch (type) {
    ...
    case BinaryOpOperation_REALDIV:
      return execute<int32_t, int32_t,
                     BinaryRealDiv<int32_t, int32_t, int32_t>>;
    ...
    case BinaryOpOperation_GREATER:
      return execute<int32_t, int32_t,
                     BinaryGreater<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_LESS:
    ...
    case BinaryOpOperation_LESS_EQUAL:
      return execute<int32_t, int32_t,
                     BinaryLessEqual<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_GREATER_EQUAL:
      return execute<int32_t, int32_t,
                     BinaryGreaterEqual<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_EQUAL:
    ...
    case BinaryOpOperation_FLOORDIV:
      return execute<int32_t, int32_t,
                     BinaryFloorDiv<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_FLOORMOD:
      return execute<int32_t, int32_t,
                     BinaryFloorMod<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_SquaredDifference:
      return execute<int32_t, int32_t,
                     BinarySquaredDifference<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_LOGICALOR:
      return execute<int32_t, int32_t,
                     BinaryLogicalOr<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_NOTEQUAL:
      return execute<int32_t, int32_t,
                     BinaryNotEqual<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_MOD:
    ...
    case BinaryOpOperation_LOGICALXOR:
      return execute<int32_t, int32_t,
                     BinaryLogicalXor<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_LEFTSHIFT:
      return execute<int32_t, int32_t,
                     BinaryLeftShift<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_RIGHTSHIFT:
      return execute<int32_t, int32_t,
                     BinaryRightShift<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_BITWISE_AND:
      return execute<int32_t, int32_t,
                     BinaryBitwiseAnd<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_BITWISE_OR:
      return execute<int32_t, int32_t,
                     BinaryBitwiseOr<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_BITWISE_XOR:
      return execute<int32_t, int32_t,
                     BinaryBitwiseXor<int32_t, int32_t, int32_t>>;
      break;
    case BinaryOpOperation_POW:
...
class CPUBinaryCreator : public CPUDevice::Creator {
 public:
