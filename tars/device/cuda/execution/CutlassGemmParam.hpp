...
using EpilogueCudaOp_F16_Linear = cutlass::epilogue::thread::LinearCombination<
    cutlass::half_t, 1, ElementAccumulator, ElementComputeEpilogue>;

using EpilogueTensorOp_F16_Linear =
    cutlass::epilogue::thread::LinearCombination<
        cutlass::half_t, 128 / cutlass::sizeof_bits<cutlass::half_t>::value,
        ElementAccumulator, ElementComputeEpilogue>;

using EpilogueCudaOp_F32_Linear =
    cutlass::epilogue::thread::LinearCombination<float, 1, ElementAccumulator,
                                                 ElementComputeEpilogue>;

using EpilogueTensorOp_F32_Linear =
    cutlass::epilogue::thread::LinearCombination<
        float, 128 / cutlass::sizeof_bits<float>::value, ElementAccumulator,
        ElementComputeEpilogue>;

using EpilogueCudaOp_F16_Relu =
    cutlass::epilogue::thread::LinearCombinationRelu<
        cutlass::half_t, 1, ElementAccumulator, ElementComputeEpilogue>;

using EpilogueTensorOp_F16_Relu =
    cutlass::epilogue::thread::LinearCombinationRelu<
        cutlass::half_t, 128 / cutlass::sizeof_bits<cutlass::half_t>::value,
        ElementAccumulator, ElementComputeEpilogue>;

using EpilogueCudaOp_F32_Relu =
    cutlass::epilogue::thread::LinearCombinationRelu<
        float, 1, ElementAccumulator, ElementComputeEpilogue>;

using EpilogueTensorOp_F32_Relu =
    cutlass::epilogue::thread::LinearCombinationRelu<
        float, 128 / cutlass::sizeof_bits<float>::value, ElementAccumulator,
        ElementComputeEpilogue>;

using EpilogueCudaOp_F16_Relu6 =
    cutlass::epilogue::thread::LinearCombinationRelu6<
        cutlass::half_t, 1, ElementAccumulator, ElementComputeEpilogue>;

using EpilogueTensorOp_F16_Relu6 =
    cutlass::epilogue::thread::LinearCombinationRelu6<
        cutlass::half_t, 128 / cutlass::sizeof_bits<cutlass::half_t>::value,
        ElementAccumulator, ElementComputeEpilogue>;

using EpilogueCudaOp_F32_Relu6 =
    cutlass::epilogue::thread::LinearCombinationRelu6<
        float, 1, ElementAccumulator, ElementComputeEpilogue>;

using EpilogueTensorOp_F32_Relu6 =
    cutlass::epilogue::thread::LinearCombinationRelu6<
        float, 128 / cutlass::sizeof_bits<float>::value, ElementAccumulator,
        ElementComputeEpilogue>;
...
using GemmCuda_F16_F16_Linear_AlignCuda = cutlass::gemm::device::Gemm<
    cutlass::half_t, LayoutInputA, cutlass::half_t, LayoutInputB,
    cutlass::half_t, LayoutOutput, ElementAccumulator,
...
using GemmCuda_F16_F32_Linear_AlignCuda = cutlass::gemm::device::Gemm<
    cutlass::half_t, LayoutInputA, cutlass::half_t, LayoutInputB, float,
    LayoutOutput, ElementAccumulator, cutlass::arch::OpClassSimt,
    cutlass::arch::Sm75, cutlass::gemm::GemmShape<64, 64, 64>,
    cutlass::gemm::GemmShape<32, 32, 64>, cutlass::gemm::GemmShape<1, 1, 1>,
    EpilogueCudaOp_F32_Linear, SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F32_Linear_AlignCuda_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm70, cutlass::gemm::GemmShape<64, 64, 64>,
    cutlass::gemm::GemmShape<32, 32, 64>, cutlass::gemm::GemmShape<8, 8, 4>,
    EpilogueCudaOp_F32_Linear, SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F32_Linear_AlignTensor_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm70, cutlass::gemm::GemmShape<64, 64, 64>,
    cutlass::gemm::GemmShape<32, 32, 64>, cutlass::gemm::GemmShape<8, 8, 4>,
    EpilogueTensorOp_F32_Linear, SwizzleThreadBlock, NumStages>;
...
using GemmCuda_F32_F32_Linear_AlignCuda = cutlass::gemm::device::Gemm<
    float, LayoutInputA, float, LayoutInputB, float, LayoutOutput,
...
using GemmCuda_F16_F16_Relu_AlignCuda = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassSimt, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<1, 1, 1>, EpilogueCudaOp_F16_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmCuda_F16_F32_Relu_AlignCuda = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm75, cutlass::gemm::GemmShape<64, 64, 64>,
    cutlass::gemm::GemmShape<32, 32, 64>, cutlass::gemm::GemmShape<1, 1, 1>,
    EpilogueCudaOp_F32_Relu, SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu_AlignCuda_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueCudaOp_F16_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu_AlignTensor_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueTensorOp_F16_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F32_Relu_AlignTensor_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm70, cutlass::gemm::GemmShape<64, 64, 64>,
    cutlass::gemm::GemmShape<32, 32, 64>, cutlass::gemm::GemmShape<8, 8, 4>,
    EpilogueTensorOp_F32_Relu, SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu_AlignCuda_Sm75 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueCudaOp_F16_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu_AlignTensor_Sm75 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueTensorOp_F16_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmCuda_F32_F32_Relu_AlignCuda = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassSimt, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<1, 1, 1>, EpilogueCudaOp_F32_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu_AlignCuda_Sm70 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueCudaOp_F32_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu_AlignTensor_Sm70 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueTensorOp_F32_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu_AlignCuda_Sm75 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueCudaOp_F32_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu_AlignTensor_Sm75 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueTensorOp_F32_Relu,
    SwizzleThreadBlock, NumStages>;
...
using GemmCuda_F16_F16_Relu6_AlignCuda = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassSimt, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<1, 1, 1>, EpilogueCudaOp_F16_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmCuda_F16_F32_Relu6_AlignCuda = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm75, cutlass::gemm::GemmShape<64, 64, 64>,
    cutlass::gemm::GemmShape<32, 32, 64>, cutlass::gemm::GemmShape<1, 1, 1>,
    EpilogueCudaOp_F32_Relu6, SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu6_AlignCuda_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueCudaOp_F16_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu6_AlignTensor_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueTensorOp_F16_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F32_Relu6_AlignTensor_Sm70 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm70, cutlass::gemm::GemmShape<64, 64, 64>,
    cutlass::gemm::GemmShape<32, 32, 64>, cutlass::gemm::GemmShape<8, 8, 4>,
    EpilogueTensorOp_F32_Relu6, SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu6_AlignCuda_Sm75 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueCudaOp_F16_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F16_F16_Relu6_AlignTensor_Sm75 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueTensorOp_F16_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmCuda_F32_F32_Relu6_AlignCuda = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassSimt, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<1, 1, 1>, EpilogueCudaOp_F32_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu6_AlignCuda_Sm70 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueCudaOp_F32_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu6_AlignTensor_Sm70 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm70,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<8, 8, 4>, EpilogueTensorOp_F32_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu6_AlignCuda_Sm75 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueCudaOp_F32_Relu6,
    SwizzleThreadBlock, NumStages>;
...
using GemmTensor_F32_F32_Relu6_AlignTensor_Sm75 = cutlass::gemm::device::Gemm<
    ...
    ElementAccumulator, cutlass::arch::OpClassTensorOp, cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 64, 64>, cutlass::gemm::GemmShape<32, 32, 64>,
    cutlass::gemm::GemmShape<16, 8, 8>, EpilogueTensorOp_F32_Relu6,
    SwizzleThreadBlock, NumStages>;
