...
class Pipeline : public NonCopyable {
  ...
  */
  Status encode(bool supportDebug = false);

  /** allocMemory: create Operation and alloc memory for every op */
  Status allocMemory(bool firstMalloc);

  /** execute this pipline */
  Status execute();

  Status executeCallBack(const TensorCallBackWithInfo& before,
