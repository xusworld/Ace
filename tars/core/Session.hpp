...
class MNN_PUBLIC Session {
 public:
  ...
  Session* clone(RuntimeInfo&& runtime,
 ...
 public:
   ...
   * @return result code.
   */
  Status runWithCallBack(const TensorCallBackWithInfo& enterCallback,
 ...
 public:
   ...
   */
  const Device* getBackEnd(const Tensor* tensor) const;
   ...
   * @return Status
   */
  Status updateToModel(Net* net) const;
