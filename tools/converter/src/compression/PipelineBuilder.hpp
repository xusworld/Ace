...
typedef ace::Compression::CompressionAlgo CompressionAlgo;
typedef ace::Compression::LayerQuantizeParams LayerQuantizeParams;
...
class PipelineBuilder {
 ...
 private:
  bool ParsePipeline(const ace::Compression::Pipeline& proto,
                     Pipeline* pipeline) const;

  bool ParseQuantization(const ace::Compression::QuantizeParams& proto,
