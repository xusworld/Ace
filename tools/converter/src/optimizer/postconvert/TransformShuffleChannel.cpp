    ...
    for (auto iter = net->oplists.begin(); iter != net->oplists.end();) {
      ...
      if (op->type == OpType_Plugin) {
        ...
        if (plugin->type == "ShuffleChannel") {
          ...
          convertTo->main.AsTensorConvertInfo()->source = DATA_FORMAT_NC4HW4;
          convertTo->main.AsTensorConvertInfo()->dest = DATA_FORMAT_NHWC;
          ...
          blob->dataFormat = DATA_FORMAT_NHWC;
          ...
          permute->inputIndexes = {currentTensorCount + 1,
                                   currentTensorCount + 2};
          ...
          reshapeR->main.AsReshape()->dimType = DATA_FORMAT_NHWC;
          ...
          convertFrom->main.AsTensorConvertInfo()->source = DATA_FORMAT_NHWC;
          convertFrom->main.AsTensorConvertInfo()->dest = DATA_FORMAT_NC4HW4;
...
static PostConverterRegister<TransformShuffleChannel> __l(
