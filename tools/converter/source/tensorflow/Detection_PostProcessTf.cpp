...
tars::OpType Detection_PostProcessTf::opType() {
  return tars::OpType_DetectionPostProcess;
}

tars::OpParameter Detection_PostProcessTf::type() {
  return tars::OpParameter_DetectionPostProcessParam;
}

void Detection_PostProcessTf::run(tars::OpT *dstOp, TmpNode *srcNode) {
