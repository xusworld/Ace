...
tars::OpType LRNOnnx::opType() { return tars::OpType_LRN; }

tars::OpParameter LRNOnnx::type() { return tars::OpParameter_LRN; }

void LRNOnnx::run(tars::OpT* dstOp, const onnx::NodeProto* onnxNode,
                  OnnxScope* scope) {
  auto param = new tars::LRNT;
