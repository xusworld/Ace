...
tars::OpType FlattenOnnx::opType() { return tars::OpType_Flatten; }

tars::OpParameter FlattenOnnx::type() { return tars::OpParameter_Flatten; }

void FlattenOnnx::run(tars::OpT *dstOp, const onnx::NodeProto *onnxNode,
                      OnnxScope *scope) {
