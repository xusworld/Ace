...
tars::OpType GemmOnnx::opType() { return tars::OpType_InnerProduct; }
tars::OpParameter GemmOnnx::type() { return tars::OpParameter_InnerProduct; }

void GemmOnnx::run(tars::OpT* dstOp, const onnx::NodeProto* onnxNode,
                   OnnxScope* scope) {
  ...
  auto gemmParam = new tars::InnerProductT;
  ...
  auto weightBlob = new tars::BlobT;
...
tars::OpType MatMulOnnx::opType() { return tars::OpType_MatMul; }

tars::OpParameter MatMulOnnx::type() { return tars::OpParameter_MatMul; }

void MatMulOnnx::run(tars::OpT* dstOp, const onnx::NodeProto* onnxNode,
                     OnnxScope* scope) {
