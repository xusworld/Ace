...
class Reshape : public OpConverter {
 public:
  ...
  Reshape() {}
  virtual ~Reshape() {}
  virtual tars::OpType opType() { return tars::OpType_Reshape; }
  virtual tars::OpParameter type() { return tars::OpParameter_Reshape; }
};

void Reshape::run(tars::OpT* dstOp, const caffe::LayerParameter& parameters,
                  const caffe::LayerParameter& weight) {
...
void Flatten::run(tars::OpT* dstOp, const caffe::LayerParameter& parameters,
                  const caffe::LayerParameter& weight) {
