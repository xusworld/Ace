...
class PrioxBox : public OpConverter {
 public:
  ...
  PrioxBox() {}
  virtual ~PrioxBox() {}
  virtual tars::OpType opType() { return tars::OpType_PriorBox; }
  virtual tars::OpParameter type() { return tars::OpParameter_PriorBox; }
};

void PrioxBox::run(tars::OpT* dstOp, const caffe::LayerParameter& parameters,
                   const caffe::LayerParameter& weight) {
  auto prior = new tars::PriorBoxT;
