...
tars::OpType Im2ColTorch::opType() { return tars::OpType_Im2Col; }

tars::OpParameter Im2ColTorch::type() {
  return tars::OpParameter_Convolution2D;
}

std::vector<int> Im2ColTorch::inputTensorIdx() { return {0}; }

void Im2ColTorch::run(tars::OpT* dstOp, const torch::jit::Node* node,
                      TorchScope* scope) {
  auto param = new tars::Convolution2DT;
  param->common.reset(new tars::Convolution2DCommonT);
...
tars::OpType Col2ImTorch::opType() { return tars::OpType_Col2Im; }

tars::OpParameter Col2ImTorch::type() {
  return tars::OpParameter_Convolution2D;
}

std::vector<int> Col2ImTorch::inputTensorIdx() { return {0, 1}; }

void Col2ImTorch::run(tars::OpT* dstOp, const torch::jit::Node* node,
                      TorchScope* scope) {
  auto param = new tars::Convolution2DT;
  param->common.reset(new tars::Convolution2DCommonT);
  auto common = param->common.get();
