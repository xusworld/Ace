...
tars::OpType ConvolutionTorch::opType() { return tars::OpType_Convolution; }
tars::OpParameter ConvolutionTorch::type() {
  return tars::OpParameter_Convolution2D;
}
std::vector<int> ConvolutionTorch::inputTensorIdx() { return {0}; }

void ConvolutionTorch::run(tars::OpT* dstOp, const torch::jit::Node* node,
                           TorchScope* scope) {
