...
tars::OpType FlipTorch::opType() { return tars::OpType_Extra; }
tars::OpParameter FlipTorch::type() { return tars::OpParameter_Extra; }
std::vector<int> FlipTorch::inputTensorIdx() { return {0}; }

void FlipTorch::run(tars::OpT* dstOp, const torch::jit::Node* node,
                    TorchScope* scope) {
