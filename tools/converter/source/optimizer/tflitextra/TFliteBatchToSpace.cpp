...
static auto gRegister = []() {
  TFliteExtraManager::get()->insert(
      "BatchToSpace", std::shared_ptr<TFliteExtraManager::Transform>(
                          new BatchToSpaceTransform));
  TFliteExtraManager::get()->insert(
      "SpaceToBatch", std::shared_ptr<TFliteExtraManager::Transform>(
                          new SpaceToBatchTransform));
  return true;
}();
}  // namespace Express
}  // namespace tars
