...
static inline MobileNetWidthType EnumMobileNetWidthTypeByString(
    const std::string& key) {
  auto mobileNetWidthTypeMap =
      std::map<std::string, MobileNetWidthType>({{"1.0", MobileNet_100},
                                                 {"0.75", MobileNet_075},
                                                 {"0.5", MobileNet_050},
                                                 {"0.25", MobileNet_025}});
...
static inline MobileNetResolutionType EnumMobileNetResolutionTypeByString(
    const std::string& key) {
  auto mobileNetResolutionTypeMap =
      std::map<std::string, MobileNetResolutionType>({{"224", MobileNet_224},
                                                      {"192", MobileNet_192},
                                                      {"160", MobileNet_160},
                                                      {"128", MobileNet_128}});
