...
static VARP fireMoudle(VARP x, int inputChannel, int squeeze_1x1,
  ...
  x = _Conv(0.0f, 0.0f, x, {inputChannel, squeeze_1x1}, {1, 1}, VALID, {1, 1},
            {1, 1}, 1);
  auto y1 = _Conv(0.0f, 0.0f, x, {squeeze_1x1, expand_1x1}, {1, 1}, VALID,
                  {1, 1}, {1, 1}, 1);
  auto y2 = _Conv(0.0f, 0.0f, x, {squeeze_1x1, expand_3x3}, {3, 3}, SAME,
                  {1, 1}, {1, 1}, 1);
