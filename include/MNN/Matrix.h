...
/* Generated by tools/bookmaker from include/core/Matrix.h and
   docs/SkMatrix_Reference.bmh on 2018-07-13 08:15:11. Additional documentation
...
/** \class Matrix
    ...
    so it has no effect. setTranslate(), setScale(), setSkew(), setRotate(),
   set9 and setAll() initializes all Matrix elements with the corresponding
   mapping.
...
class MNN_PUBLIC Matrix {
  ...
  */
  static Matrix MakeAll(float scaleX, float skewX, float transX, float skewY,
                        float scaleY, float transY, float pers0, float pers1,
                        float pers2) {
    Matrix m;
  ...
  */
  ...
  /** Returns true if Matrix at most scales and translates. Matrix may be
  ...
  */
  ...
  /** Returns true Matrix maps Rect to another Rect. If true, Matrix is
     identity, or scales, or rotates a multiple of 90 degrees, or mirrors on
     axes. In all cases, Matrix may also have translation. Matrix form is
     either:
  ...
  */
  ...
  /** Returns scale factor multiplied by x-axis input, contributing to x-axis
     output. With mapPoints(), scales Point along the x-axis.
  ...
  */
  ...
  /** Returns scale factor multiplied by y-axis input, contributing to y-axis
     output. With mapPoints(), scales Point along the y-axis.
  ...
  */
  ...
  /** Returns scale factor multiplied by x-axis input, contributing to y-axis
     output. With mapPoints(), skews Point along the y-axis. Skewing both axes
     can rotate Point.
  ...
  */
  ...
  /** Returns scale factor multiplied by y-axis input, contributing to x-axis
     output. With mapPoints(), skews Point along the x-axis. Skewing both axes
     can rotate Point.
  ...
  */
  ...
  /** Returns writable Matrix value. Asserts if index is out of range and
     SK_DEBUG is defined. Clears internal cache anticipating that caller will
     change Matrix value.

      Next call to read Matrix state may recompute cache; subsequent writes to
     Matrix value must be followed by dirtyMatrixTypeCache().
  ...
  */
  void setAll(float scaleX, float skewX, float transX, float skewY,
              float scaleY, float transY, float persp0, float persp1,
              float persp2) {
  ...
  */
  ...
  /** Sets Matrix to nine scalar values in buffer, in member value ascending
     ...
     Matrix maps non-homogeneous coordinates, scaling all nine values produces
  ...
  */
  ...
  /** Sets Matrix to identity; which has no effect on mapped Point. Sets Matrix
     to:
  ...
  */
  ...
  /** Sets Matrix to rotate by sinValue and cosValue, about a pivot point at
     (px, py). The pivot point is unchanged when mapped with Matrix.
  ...
  */
  ...
  /** Sets Matrix to rotate by sinValue and cosValue, about a pivot point at (0,
     0).
  ...
  */
  ...
  /** Sets Matrix to Matrix multiplied by Matrix constructed from translation
     (dx, dy). This can be thought of as moving the point to be mapped before
     applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix multiplied by Matrix constructed from scaling by
     (sx, sy) about pivot point (px, py). This can be thought of as scaling
     about a pivot point before applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix multiplied by Matrix constructed from scaling by
     (sx, sy) about pivot point (0, 0). This can be thought of as scaling about
     the origin before applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix multiplied by Matrix constructed from rotating by
     degrees about pivot point (px, py). This can be thought of as rotating
     about a pivot point before applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix multiplied by Matrix constructed from rotating by
     degrees about pivot point (0, 0). This can be thought of as rotating about
     the origin before applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix multiplied by Matrix constructed from skewing by
     (kx, ky) about pivot point (px, py). This can be thought of as skewing
     about a pivot point before applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix multiplied by Matrix constructed from skewing by
     (kx, ky) about pivot point (0, 0). This can be thought of as skewing about
     the origin before applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from translation (dx, dy) multiplied by
     Matrix. This can be thought of as moving the point to be mapped after
     applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from scaling by (sx, sy) about pivot
     point (px, py), multiplied by Matrix. This can be thought of as scaling
     about a pivot point after applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from scaling by (sx, sy) about pivot
     point (0, 0), multiplied by Matrix. This can be thought of as scaling about
     the origin after applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from scaling by (1/divx, 1/divy) about
     pivot point (px, py), multiplied by Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from rotating by degrees about pivot
     point (px, py), multiplied by Matrix. This can be thought of as rotating
     about a pivot point after applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from rotating by degrees about pivot
     point (0, 0), multiplied by Matrix. This can be thought of as rotating
     about the origin after applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from skewing by (kx, ky) about pivot
     point (px, py), multiplied by Matrix. This can be thought of as skewing
     about a pivot point after applying Matrix.
  ...
  */
  ...
  /** Sets Matrix to Matrix constructed from skewing by (kx, ky) about pivot
     point (0, 0), multiplied by Matrix. This can be thought of as skewing about
     the origin after applying Matrix.
  ...
  */
  ...
  /** \enum Matrix::ScaleToFit
      ...
      ScaleToFit may allow Matrix to have unequal horizontal and vertical
     scaling, or may restrict Matrix to square scaling. If restricted,
     ScaleToFit specifies how Matrix maps to the side or center of the
     destination Rect.
  */
  enum ScaleToFit {
  ...
  /** Sets Matrix to scale and translate src Rect to dst Rect. stf selects
     whether mapping completely fills dst or preserves the aspect ratio, and how
     to align src within dst. Returns false if src is empty, and sets Matrix to
     identity. Returns true if dst is empty, and sets Matrix to:
  ...
  */
  ...
  /** Returns Matrix set to scale and translate src Rect to dst Rect. stf
     selects whether mapping completely fills dst or preserves the aspect ratio,
     and how to align src within dst. Returns the identity Matrix if src is
     empty. If dst is empty, returns Matrix set to:
  ...
  */
  static Matrix MakeRectToRect(const Rect& src, const Rect& dst,
                               ScaleToFit stf) {
    Matrix m;
  ...
  /** Sets Matrix to map src to dst. count must be zero or greater, and four or
     less.

      If count is zero, sets Matrix to identity and returns true.
      If count is one, sets Matrix to translate and returns true.
      If count is two or more, sets Matrix to map Point if possible; returns
     false if Matrix cannot be constructed. If count is four, Matrix may include
      perspective.
  ...
  */
  ...
  /** Sets inverse to reciprocal matrix, returning true if Matrix can be
     inverted. Geometrically, if Matrix maps from source to destination, inverse
     Matrix maps from destination to source. If Matrix can not be inverted,
  ...
  */
  ...
  /** Maps src Point array of length count to dst Point array of equal or
     greater length. Point are mapped by multiplying each Point by Matrix.
     Given:
  ...
  */
  ...
  /** Maps pts Point array of length count in place. Point are mapped by
     multiplying each Point by Matrix. Given:
  ...
  */
  ...
  /** Maps Point (x, y) to result. Point is mapped by multiplying by Matrix.
     Given:
  ...
  */
  ...
  /** Compares a and b; returns true if a and b are numerically equal. Returns
     ...
     Matrix contains NaN, even if the other Matrix also contains NaN.
  ...
  */
  ...
  /** Compares a and b; returns true if a and b are not numerically equal.
     ...
     either Matrix contains NaN, even if the other Matrix also contains NaN.
  ...
  */
  ...
  /** Writes text representation of Matrix to standard output. Floating point
     values are written with limited precision; it may not be possible to
     reconstruct original Matrix from output.
  */
  void dump() const;

  /** Returns the minimum scaling factor of Matrix by decomposing the scaling
     and skewing elements. Returns -1 if scale factor overflows or Matrix
  ...
  */
  ...
  /** Returns the maximum scaling factor of Matrix by decomposing the scaling
     and skewing elements. Returns -1 if scale factor overflows or Matrix
     contains perspective.
  ...
  */
  ...
  /** Sets scaleFactors[0] to the minimum scaling factor, and scaleFactors[1] to
     ...
     Matrix scaling and skewing elements.
  ...
  */
  ...
  /** Sets internal cache to unknown state. Use to force update after repeated
      modifications to Matrix element reference returned by operator[](int
     index).
  */
  ...
  */
  ...
  static void ComputeInv(float dst[9], const float src[9], double invDet,
                         bool isPersp);
