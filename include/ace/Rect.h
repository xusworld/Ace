...
/* Generated by tools/bookmaker from include/core/Rect.h and
   docs/SkRect_Reference.bmh on 2018-07-13 08:15:11. Additional documentation
...
struct MNN_PUBLIC Rect {
  ...
  */
  static constexpr Rect MakeWH(float w, float h) { return Rect{0, 0, w, h}; }

  /** Returns constructed Rect set to integer values (0, 0, w, h). Does not
     validate input; w or h may be negative.
  ...
  */
  ...
  /** Returns constructed Rect set to (l, t, r, b). Does not sort input; Rect
     may result in fLeft greater than fRight, or fTop greater than fBottom.
  ...
  */
  ...
  /** Returns constructed Rect set to (x, y, x + w, y + h). Does not validate
  ...
  */
  ...
  /** Returns left edge of Rect, if sorted. Call isSorted() to see if Rect is
     valid. Call sort() to reverse fLeft and fRight if needed.

      @return  fLeft
  */
  float x() const { return fLeft; }

  /** Returns top edge of Rect, if sorted. Call isEmpty() to see if Rect may be
     invalid, and sort() to reverse fTop and fBottom if needed.
  ...
  */
  ...
  /** Returns right edge of Rect, if sorted. Call isSorted() to see if Rect is
     valid. Call sort() to reverse fLeft and fRight if needed.
  ...
  */
  ...
  /** Returns bottom edge of Rect, if sorted. Call isEmpty() to see if Rect may
  ...
  */
  ...
  /** Returns average of left edge and right edge. Result does not change if
     Rect is sorted. Result may overflow to infinity if Rect is far from the
     origin.

      @return  midpoint in x
  */
  float centerX() const {
    // don't use floatHalf(fLeft + fBottom) as that might overflow before the
    // 0.5
  ...
  */
  ...
  /** Sets Rect to (0, 0, width, height).
     ...
     from integer to float, large values may lose precision.
  ...
  */
  ...
  /** Offsets Rect by adding dx to fLeft, fRight; and by adding dy to fTop,
     fBottom.
  ...
  */
  ...
  /** Offsets Rect so that fLeft equals newX, and fTop equals newY. width and
 ...
 private:
  static bool Intersects(float al, float at, float ar, float ab, float bl,
                         float bt, float br, float bb) {
 ...
 public:
  /** Constructs Rect to intersect from (left, top, right, bottom). Does not
     sort construction.

      Returns true if Rect intersects construction.
      Returns false if either construction or Rect is empty, or do not
     intersect.
  ...
  */
  ...
  /** Returns Rect with fLeft and fRight swapped if fLeft is greater than
