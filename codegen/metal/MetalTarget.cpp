...
namespace tars {
std::string MetalTarget::type() { return "auto "; }
...
std::string MetalTarget::number(float val) { return numval(val); }
std::string MetalTarget::codegen(std::vector<std::string>& inputs,
                                 const Op* op) {
  std::stringstream ss;
  switch (op->type()) {
...
std::string MetalTarget::load(const std::string& base,
...
std::string MetalTarget::store(const std::string base,
                               const std::string& offset,
                               const std::string& data) {
  return base + "[" + offset + "] = " + data + ";\n";
}

std::string MetalTarget::proto(const std::string& name,
