...
int main(int argc, char* argv[]) {
  ...
  auto mnnNet = std::shared_ptr<tars::Interpreter>(
      tars::Interpreter::createFromFile(poseModel));
  tars::ScheduleConfig netConfig;
  ...
  //  {
  //      tars::Tensor givenTensor(input, Tensor::CAFFE);
  ...
  auto displacementFwd =
      mnnNet->getSessionOutput(session, DISPLACE_FWD_NODE_NAME);
  auto displacementBwd =
      mnnNet->getSessionOutput(session, DISPLACE_BWD_NODE_NAME);
