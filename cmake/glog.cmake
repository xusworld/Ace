...
message(STATUS "Ace third party path is " ${TARS_THIRD_PARTY_PATH})

set(GLOG_PROJECT       "external_glog")
set(GLOG_SOURCE_DIR    ${TARS_TEMP_THIRD_PARTY_PATH}/glog)
set(GLOG_INSTALL_DIR   ${TARS_THIRD_PARTY_PATH}/glog)
