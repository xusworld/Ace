...
#ifndef FLATBUFFERS_GENERATED_TFQUANTIZEOP_ACE_H_
#define FLATBUFFERS_GENERATED_TFQUANTIZEOP_ACE_H_
...
struct QuantizedAddT : public flatbuffers::NativeTable {
  ...
  ace::FusedActivation activationType = ace::FusedActivation_kTfLiteActNone;
  std::unique_ptr<ace::QuantizedParamT> input1QuantizedParam{};
  std::unique_ptr<ace::QuantizedParamT> input2QuantizedParam{};
  std::unique_ptr<ace::QuantizedParamT> outputQuantizedParam{};
  QuantizedAddT() = default;
  QuantizedAddT(const QuantizedAddT &o);
  QuantizedAddT(QuantizedAddT&&) FLATBUFFERS_NOEXCEPT = default;
  QuantizedAddT &operator=(QuantizedAddT o) FLATBUFFERS_NOEXCEPT;
};
...
struct QuantizedAdd FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  ace::FusedActivation activationType() const {
    return static_cast<ace::FusedActivation>(GetField<int8_t>(VT_ACTIVATIONTYPE, 0));
  }
  const ace::QuantizedParam *input1QuantizedParam() const {
    return GetPointer<const ace::QuantizedParam *>(VT_INPUT1QUANTIZEDPARAM);
  }
  const ace::QuantizedParam *input2QuantizedParam() const {
    return GetPointer<const ace::QuantizedParam *>(VT_INPUT2QUANTIZEDPARAM);
  }
  const ace::QuantizedParam *outputQuantizedParam() const {
    return GetPointer<const ace::QuantizedParam *>(VT_OUTPUTQUANTIZEDPARAM);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct QuantizedAddBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_activationType(ace::FusedActivation activationType) {
    fbb_.AddElement<int8_t>(QuantizedAdd::VT_ACTIVATIONTYPE, static_cast<int8_t>(activationType), 0);
  }
  void add_input1QuantizedParam(flatbuffers::Offset<ace::QuantizedParam> input1QuantizedParam) {
    fbb_.AddOffset(QuantizedAdd::VT_INPUT1QUANTIZEDPARAM, input1QuantizedParam);
  }
  void add_input2QuantizedParam(flatbuffers::Offset<ace::QuantizedParam> input2QuantizedParam) {
    fbb_.AddOffset(QuantizedAdd::VT_INPUT2QUANTIZEDPARAM, input2QuantizedParam);
  }
  void add_outputQuantizedParam(flatbuffers::Offset<ace::QuantizedParam> outputQuantizedParam) {
...
inline flatbuffers::Offset<QuantizedAdd> CreateQuantizedAdd(
    flatbuffers::FlatBufferBuilder &_fbb,
    ace::FusedActivation activationType = ace::FusedActivation_kTfLiteActNone,
    flatbuffers::Offset<ace::QuantizedParam> input1QuantizedParam = 0,
    flatbuffers::Offset<ace::QuantizedParam> input2QuantizedParam = 0,
    flatbuffers::Offset<ace::QuantizedParam> outputQuantizedParam = 0) {
...
struct DequantizeT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<ace::QuantizedParamT> inputQuantizedParam{};
  ace::QuantizeMode mode = ace::QuantizeMode_MIN_COMBINED;
  ace::ModeFormat modelFormat = ace::ModeFormat_TENSORFLOW;
  ace::DataType type = ace::DataType_DT_INVALID;
  DequantizeT() = default;
  DequantizeT(const DequantizeT &o);
  DequantizeT(DequantizeT&&) FLATBUFFERS_NOEXCEPT = default;
  DequantizeT &operator=(DequantizeT o) FLATBUFFERS_NOEXCEPT;
};
...
struct Dequantize FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const ace::QuantizedParam *inputQuantizedParam() const {
    return GetPointer<const ace::QuantizedParam *>(VT_INPUTQUANTIZEDPARAM);
  }
  ace::QuantizeMode mode() const {
    return static_cast<ace::QuantizeMode>(GetField<int8_t>(VT_MODE, 0));
  }
  ace::ModeFormat modelFormat() const {
    return static_cast<ace::ModeFormat>(GetField<int8_t>(VT_MODELFORMAT, 0));
  }
...
struct DequantizeBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_inputQuantizedParam(flatbuffers::Offset<ace::QuantizedParam> inputQuantizedParam) {
    fbb_.AddOffset(Dequantize::VT_INPUTQUANTIZEDPARAM, inputQuantizedParam);
  }
  void add_mode(ace::QuantizeMode mode) {
    fbb_.AddElement<int8_t>(Dequantize::VT_MODE, static_cast<int8_t>(mode), 0);
  }
  void add_modelFormat(ace::ModeFormat modelFormat) {
...
inline flatbuffers::Offset<Dequantize> CreateDequantize(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<ace::QuantizedParam> inputQuantizedParam = 0,
    ace::QuantizeMode mode = ace::QuantizeMode_MIN_COMBINED,
    ace::ModeFormat modelFormat = ace::ModeFormat_TENSORFLOW,
    ace::DataType type = ace::DataType_DT_INVALID) {
...
struct QuantizedBiasAddT : public flatbuffers::NativeTable {
  ...
  ace::DataType inputType = ace::DataType_DT_INVALID;
  int32_t max = 0;
  int32_t min = 0;
...
struct QuantizedBiasAdd FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  ace::DataType inputType() const {
    return static_cast<ace::DataType>(GetField<int32_t>(VT_INPUTTYPE, 0));
  }
  int32_t max() const {
...
struct QuantizedBiasAddBuilder {
  ...
  void add_inputType(ace::DataType inputType) {
...
inline flatbuffers::Offset<QuantizedBiasAdd> CreateQuantizedBiasAddDirect(
  ...
  return ace::CreateQuantizedBiasAdd(
      _fbb,
      bias__,
      inputType,
      max,
...
struct QuantizedConcatT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<ace::QuantizedParamT> outputQuantizedParam{};
  QuantizedConcatT() = default;
  QuantizedConcatT(const QuantizedConcatT &o);
  QuantizedConcatT(QuantizedConcatT&&) FLATBUFFERS_NOEXCEPT = default;
  QuantizedConcatT &operator=(QuantizedConcatT o) FLATBUFFERS_NOEXCEPT;
};
...
inline flatbuffers::Offset<QuantizedConcat> CreateQuantizedConcatDirect(
  ...
  return ace::CreateQuantizedConcat(
      _fbb,
      activationType,
      axis,
      inputScale__,
...
struct QuantizedLogisticT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<ace::QuantizedParamT> inputQuantizedParam{};
  std::unique_ptr<ace::QuantizedParamT> outputQuantizedParam{};
  QuantizedLogisticT() = default;
  QuantizedLogisticT(const QuantizedLogisticT &o);
  QuantizedLogisticT(QuantizedLogisticT&&) FLATBUFFERS_NOEXCEPT = default;
  QuantizedLogisticT &operator=(QuantizedLogisticT o) FLATBUFFERS_NOEXCEPT;
};
...
inline flatbuffers::Offset<QuantizedReshape> CreateQuantizedReshapeDirect(
  ...
  return ace::CreateQuantizedReshape(
      _fbb,
      dims__,
      modelFormat);
}
...
struct QuantizeV2T : public flatbuffers::NativeTable {
  ...
  ace::DataType type = ace::DataType_DT_INVALID;
  ace::QuantizeMode mode = ace::QuantizeMode_MIN_COMBINED;
  ace::QuantizeRoundMode roundMode = ace::QuantizeRoundMode_HALF_AWAY_FROM_ZERO;
};
...
struct QuantizeV2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  ace::QuantizeRoundMode roundMode() const {
    return static_cast<ace::QuantizeRoundMode>(GetField<int8_t>(VT_ROUNDMODE, 0));
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_TYPE, 4) &&
...
struct QuantizeV2Builder {
  ...
  void add_roundMode(ace::QuantizeRoundMode roundMode) {
...
struct TfQuantizedConv2DT : public flatbuffers::NativeTable {
  ...
  int32_t outMin = 0;
  int32_t shift = 0;
  std::unique_ptr<ace::QuantizedParamT> biasQuantizedParam{};
  int32_t depthMultiplier = 0;
  std::unique_ptr<ace::QuantizedParamT> filterQuantizedParam{};
  std::unique_ptr<ace::QuantizedParamT> inputQuantizedParam{};
  ace::ModeFormat modelFormat = ace::ModeFormat_TENSORFLOW;
  std::unique_ptr<ace::QuantizedParamT> outputQuantizedParam{};
  TfQuantizedConv2DT() = default;
  TfQuantizedConv2DT(const TfQuantizedConv2DT &o);
  TfQuantizedConv2DT(TfQuantizedConv2DT&&) FLATBUFFERS_NOEXCEPT = default;
  TfQuantizedConv2DT &operator=(TfQuantizedConv2DT o) FLATBUFFERS_NOEXCEPT;
};
...
struct TfQuantizedConv2D FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const ace::QuantizedParam *biasQuantizedParam() const {
    return GetPointer<const ace::QuantizedParam *>(VT_BIASQUANTIZEDPARAM);
  }
  int32_t depthMultiplier() const {
    return GetField<int32_t>(VT_DEPTHMULTIPLIER, 0);
  }
  const ace::QuantizedParam *filterQuantizedParam() const {
    return GetPointer<const ace::QuantizedParam *>(VT_FILTERQUANTIZEDPARAM);
  }
  const ace::QuantizedParam *inputQuantizedParam() const {
    return GetPointer<const ace::QuantizedParam *>(VT_INPUTQUANTIZEDPARAM);
  }
...
struct TfQuantizedConv2DBuilder {
  ...
  void add_biasQuantizedParam(flatbuffers::Offset<ace::QuantizedParam> biasQuantizedParam) {
  ...
  void add_filterQuantizedParam(flatbuffers::Offset<ace::QuantizedParam> filterQuantizedParam) {
...
inline flatbuffers::Offset<TfQuantizedConv2D> CreateTfQuantizedConv2D(
    ...
    int32_t outMin = 0,
    int32_t shift = 0,
    flatbuffers::Offset<ace::QuantizedParam> biasQuantizedParam = 0,
    int32_t depthMultiplier = 0,
    flatbuffers::Offset<ace::QuantizedParam> filterQuantizedParam = 0,
    flatbuffers::Offset<ace::QuantizedParam> inputQuantizedParam = 0,
    ace::ModeFormat modelFormat = ace::ModeFormat_TENSORFLOW,
    flatbuffers::Offset<ace::QuantizedParam> outputQuantizedParam = 0) {
...
inline flatbuffers::Offset<TfQuantizedConv2D> CreateTfQuantizedConv2DDirect(
  ...
  return ace::CreateTfQuantizedConv2D(
      _fbb,
      bias__,
      biasflag,
      common,
...
inline flatbuffers::Offset<QuantizedParam> CreateQuantizedParam(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedParamT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return ace::CreateQuantizedParam(
      _fbb,
      _zeroPoint,
      _scale);
}

inline QuantizedAddT::QuantizedAddT(const QuantizedAddT &o)
      : activationType(o.activationType),
        input1QuantizedParam((o.input1QuantizedParam) ? new ace::QuantizedParamT(*o.input1QuantizedParam) : nullptr),
        input2QuantizedParam((o.input2QuantizedParam) ? new ace::QuantizedParamT(*o.input2QuantizedParam) : nullptr),
        outputQuantizedParam((o.outputQuantizedParam) ? new ace::QuantizedParamT(*o.outputQuantizedParam) : nullptr) {
}

inline QuantizedAddT &QuantizedAddT::operator=(QuantizedAddT o) FLATBUFFERS_NOEXCEPT {
  std::swap(activationType, o.activationType);
  std::swap(input1QuantizedParam, o.input1QuantizedParam);
  std::swap(input2QuantizedParam, o.input2QuantizedParam);
  std::swap(outputQuantizedParam, o.outputQuantizedParam);
  return *this;
}
...
inline void QuantizedAdd::UnPackTo(QuantizedAddT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = input1QuantizedParam(); if (_e) _o->input1QuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
  { auto _e = input2QuantizedParam(); if (_e) _o->input2QuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
  { auto _e = outputQuantizedParam(); if (_e) _o->outputQuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
}
...
inline DequantizeT::DequantizeT(const DequantizeT &o)
      : inputQuantizedParam((o.inputQuantizedParam) ? new ace::QuantizedParamT(*o.inputQuantizedParam) : nullptr),
        mode(o.mode),
        modelFormat(o.modelFormat),
        type(o.type) {
}

inline DequantizeT &DequantizeT::operator=(DequantizeT o) FLATBUFFERS_NOEXCEPT {
  std::swap(inputQuantizedParam, o.inputQuantizedParam);
  std::swap(mode, o.mode);
  std::swap(modelFormat, o.modelFormat);
...
inline void Dequantize::UnPackTo(DequantizeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = inputQuantizedParam(); if (_e) _o->inputQuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
...
inline flatbuffers::Offset<QuantizedAvgPool> CreateQuantizedAvgPool(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedAvgPoolT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _type = _o->type;
  return ace::CreateQuantizedAvgPool(
      _fbb,
      _kernelX,
      _kernelY,
      _modelFormat,
...
inline QuantizedConcatT::QuantizedConcatT(const QuantizedConcatT &o)
      : activationType(o.activationType),
        axis(o.axis),
        inputScale(o.inputScale),
        inputZeroPoint(o.inputZeroPoint),
        outputQuantizedParam((o.outputQuantizedParam) ? new ace::QuantizedParamT(*o.outputQuantizedParam) : nullptr) {
}

inline QuantizedConcatT &QuantizedConcatT::operator=(QuantizedConcatT o) FLATBUFFERS_NOEXCEPT {
  std::swap(activationType, o.activationType);
  std::swap(axis, o.axis);
  std::swap(inputScale, o.inputScale);
  std::swap(inputZeroPoint, o.inputZeroPoint);
  std::swap(outputQuantizedParam, o.outputQuantizedParam);
  return *this;
}
...
inline QuantizedLogisticT::QuantizedLogisticT(const QuantizedLogisticT &o)
      : inputQuantizedParam((o.inputQuantizedParam) ? new ace::QuantizedParamT(*o.inputQuantizedParam) : nullptr),
        outputQuantizedParam((o.outputQuantizedParam) ? new ace::QuantizedParamT(*o.outputQuantizedParam) : nullptr) {
}

inline QuantizedLogisticT &QuantizedLogisticT::operator=(QuantizedLogisticT o) FLATBUFFERS_NOEXCEPT {
  std::swap(inputQuantizedParam, o.inputQuantizedParam);
  std::swap(outputQuantizedParam, o.outputQuantizedParam);
  return *this;
}
...
inline flatbuffers::Offset<QuantizedLogistic> CreateQuantizedLogistic(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedLogisticT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _inputQuantizedParam = _o->inputQuantizedParam ? CreateQuantizedParam(_fbb, _o->inputQuantizedParam.get(), _rehasher) : 0;
  auto _outputQuantizedParam = _o->outputQuantizedParam ? CreateQuantizedParam(_fbb, _o->outputQuantizedParam.get(), _rehasher) : 0;
  return ace::CreateQuantizedLogistic(
      _fbb,
      _inputQuantizedParam,
      _outputQuantizedParam);
}
...
inline flatbuffers::Offset<QuantizedMatMul> CreateQuantizedMatMul(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedMatMulT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return ace::CreateQuantizedMatMul(
      _fbb,
      _transposeA,
      _transposeB);
}
...
inline flatbuffers::Offset<QuantizedMaxPool> CreateQuantizedMaxPool(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedMaxPoolT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _strideY = _o->strideY;
  auto _type = _o->type;
  return ace::CreateQuantizedMaxPool(
      _fbb,
      _kernelX,
      _kernelY,
      _modelFormat,
...
inline flatbuffers::Offset<QuantizedRelu> CreateQuantizedRelu(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedReluT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _type = _o->type;
  return ace::CreateQuantizedRelu(
      _fbb,
      _type);
}
...
inline flatbuffers::Offset<QuantizedRelu6> CreateQuantizedRelu6(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedRelu6T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _type = _o->type;
  return ace::CreateQuantizedRelu6(
      _fbb,
      _type);
}
...
inline flatbuffers::Offset<QuantizedSoftmax> CreateQuantizedSoftmax(flatbuffers::FlatBufferBuilder &_fbb, const QuantizedSoftmaxT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return ace::CreateQuantizedSoftmax(
      _fbb,
      _beta,
      _inputScale);
}
...
inline flatbuffers::Offset<RequantizationRange> CreateRequantizationRange(flatbuffers::FlatBufferBuilder &_fbb, const RequantizationRangeT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return ace::CreateRequantizationRange(
      _fbb);
}
...
inline flatbuffers::Offset<Requantize> CreateRequantize(flatbuffers::FlatBufferBuilder &_fbb, const RequantizeT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return ace::CreateRequantize(
      _fbb);
}

inline TfQuantizedConv2DT::TfQuantizedConv2DT(const TfQuantizedConv2DT &o)
      : bias(o.bias),
        biasflag(o.biasflag),
        ...
        outMin(o.outMin),
        shift(o.shift),
        biasQuantizedParam((o.biasQuantizedParam) ? new ace::QuantizedParamT(*o.biasQuantizedParam) : nullptr),
        depthMultiplier(o.depthMultiplier),
        filterQuantizedParam((o.filterQuantizedParam) ? new ace::QuantizedParamT(*o.filterQuantizedParam) : nullptr),
        inputQuantizedParam((o.inputQuantizedParam) ? new ace::QuantizedParamT(*o.inputQuantizedParam) : nullptr),
        modelFormat(o.modelFormat),
        outputQuantizedParam((o.outputQuantizedParam) ? new ace::QuantizedParamT(*o.outputQuantizedParam) : nullptr) {
}

inline TfQuantizedConv2DT &TfQuantizedConv2DT::operator=(TfQuantizedConv2DT o) FLATBUFFERS_NOEXCEPT {
  std::swap(bias, o.bias);
  std::swap(biasflag, o.biasflag);
  std::swap(common, o.common);
  std::swap(weight, o.weight);
  std::swap(activationType, o.activationType);
  std::swap(multiplier, o.multiplier);
  std::swap(outMax, o.outMax);
  std::swap(outMin, o.outMin);
  std::swap(shift, o.shift);
  std::swap(biasQuantizedParam, o.biasQuantizedParam);
  std::swap(depthMultiplier, o.depthMultiplier);
  std::swap(filterQuantizedParam, o.filterQuantizedParam);
  std::swap(inputQuantizedParam, o.inputQuantizedParam);
  std::swap(modelFormat, o.modelFormat);
  std::swap(outputQuantizedParam, o.outputQuantizedParam);
  return *this;
...
inline void TfQuantizedConv2D::UnPackTo(TfQuantizedConv2DT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = biasQuantizedParam(); if (_e) _o->biasQuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
  { auto _e = depthMultiplier(); _o->depthMultiplier = _e; }
  { auto _e = filterQuantizedParam(); if (_e) _o->filterQuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
  { auto _e = inputQuantizedParam(); if (_e) _o->inputQuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
  { auto _e = modelFormat(); _o->modelFormat = _e; }
  { auto _e = outputQuantizedParam(); if (_e) _o->outputQuantizedParam = std::unique_ptr<ace::QuantizedParamT>(_e->UnPack(_resolver)); }
}
...
inline const flatbuffers::TypeTable *QuantizeRoundModeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    ace::QuantizeRoundModeTypeTable
  };
  static const char * const names[] = {
    "HALF_AWAY_FROM_ZERO",
    "HALF_TO_EVEN"
...
#endif  // FLATBUFFERS_GENERATED_TFQUANTIZEOP_ACE_H_
