 ...
 public:
  virtual bool onComputeSize(
    ...
    if (nullptr == momentsParam->dim()) {
      ...
      TensorUtils::getDescribe(mean)->dimensionFormat = DATA_FORMAT_NCHW;
      TensorUtils::getDescribe(variance)->dimensionFormat = DATA_FORMAT_NCHW;
      return true;
    }
    ...
    TensorUtils::getDescribe(mean)->dimensionFormat = DATA_FORMAT_NC4HW4;
    TensorUtils::getDescribe(variance)->dimensionFormat = DATA_FORMAT_NC4HW4;
