...
GeometryComputer::Context::Context(std::shared_ptr<Backend> allocBackend,
                                   bool permitVirtual, DeviceType type) {
...
void GeometryComputer::Context::getRasterCacheCreateRecurrse(
...
class GeometryComputerManager {
 public:
  ...
  static void init() { gInstance = new GeometryComputerManager; }
