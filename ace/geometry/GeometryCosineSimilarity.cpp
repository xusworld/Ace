...
class GeometryCosineSimilarity : public GeometryComputer {
 public:
  virtual bool onCompute(const Op* op, const std::vector<Tensor*>& inputs,
    ...
    {
      tmpInput0.reset(
          Tensor::createDevice<float>({outside, channel, inside}, dimType));
    ...
    std::shared_ptr<Tensor> tmpInput1;
    {
      ...
      outputDes->memoryType = Tensor::InsideDescribe::MEMORY_VIRTUAL;
      outputDes->dimensionFormat = DATA_FORMAT_NCHW;
    ...
    std::shared_ptr<Tensor> tmpInput0x0;
    {
      ...
      auto cmd = GeometryComputerUtils::makeBinary(
          BinaryOpOperation_MUL, tmpInput0.get(), tmpInput0.get(),
          tmpInput0x0.get());
    ...
    std::shared_ptr<Tensor> tmpInput0x1;
    {
      ...
      auto cmd = GeometryComputerUtils::makeBinary(
          BinaryOpOperation_MUL, tmpInput0.get(), tmpInput1.get(),
          tmpInput0x1.get());
    ...
    std::shared_ptr<Tensor> tmpInput1x1;
    {
      tmpInput1x1.reset(
          Tensor::createDevice<float>({outside, channel, inside}, dimType));
      auto cmd = GeometryComputerUtils::makeBinary(
          BinaryOpOperation_MUL, tmpInput1.get(), tmpInput1.get(),
          tmpInput1x1.get());
    ...
    {
      sumValue0x0.reset(
          Tensor::createDevice<float>({outside, 1, inside}, dimType));
      auto des = TensorUtils::getDescribe(sumValue0x0.get());
      auto cmd = GeometryComputerUtils::makeReduce(
          ReductionType_SUM, tmpInput0x0.get(), sumValue0x0.get());
    ...
    std::shared_ptr<Tensor> sumValue0x1;
    {
      ...
      auto cmd = GeometryComputerUtils::makeReduce(
          ReductionType_SUM, tmpInput0x1.get(), sumValue0x1.get());
    ...
    std::shared_ptr<Tensor> sumValue1x1;
    {
      ...
      auto cmd = GeometryComputerUtils::makeReduce(
          ReductionType_SUM, tmpInput1x1.get(), sumValue1x1.get());
    ...
    {
      mulValue0x0_1x1.reset(
          Tensor::createDevice<float>({outside, 1, inside}, dimType));
      auto des = TensorUtils::getDescribe(mulValue0x0_1x1.get());

      auto cmd = GeometryComputerUtils::makeBinary(
          BinaryOpOperation_MUL, sumValue0x0.get(), sumValue1x1.get(),
          mulValue0x0_1x1.get());
    ...
    std::shared_ptr<Tensor> mulValue0x0_1x1_eps;
    {
      ...
      auto cmd = GeometryComputerUtils::makeBinary(
          BinaryOpOperation_ADD, mulValue0x0_1x1.get(), epsTensor.get(),
          mulValue0x0_1x1_eps.get());
    ...
    std::shared_ptr<Tensor> sqrtMulValue;
    {
      ...
      auto cmd = GeometryComputerUtils::makeUnary(
          UnaryOpOperation_SQRT, mulValue0x0_1x1_eps.get(), sqrtMulValue.get());
    ...
    std::shared_ptr<Tensor> tmpOutput;
    {
      ...
      auto cmd = GeometryComputerUtils::makeBinary(
          BinaryOpOperation_REALDIV, sumValue0x1.get(), sqrtMulValue.get(),
          tmpOutput.get());
