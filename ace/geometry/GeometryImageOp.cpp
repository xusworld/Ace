...
static void _ConverterInterp(const Interp* resize, InterpInfo* dstInfo, int inW,
  ...
  switch (resize->ctm()) {
    ...
    case CoordinateTransformationMode_TensorflowCropAndResize: {
      ...
      MNN_ERROR(
          "Don't support CoordinateTransformationMode_TensorflowCropAndResize "
          "currently\n");
      break;
    }
    default:
...
static void _create() {
  ...
  GeometryComputer::registerGeometryComputer(
      ...
      {OpType_ConvInt8, OpType_DepthwiseConvInt8, OpType_ConvolutionDepthwise,
       ...
       OpType_Resize, OpType_Int8ToFloat, OpType_FloatToInt8});
}
