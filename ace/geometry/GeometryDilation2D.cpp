 ...
 public:
  virtual bool onCompute(const Op* op, const std::vector<Tensor*>& inputs,
    ...
    Tensor *A = nullptr, *B = nullptr, *C = nullptr, *D = nullptr, *E = nullptr;
    {
      ...
      GeometryConvUtils::im2Col(
          im2Col.get(), input, inputChannel, kernelHeight, kernelWidth, batch,
    ...
    }
    {
      ...
      C = addValue.get();
      auto cmd =
          GeometryComputerUtils::makeBinary(BinaryOpOperation_ADD, A, B, C);
    ...
    }
    {
      ...
      kernelDiffDes->dimensionFormat = DATA_FORMAT_NCHW;
