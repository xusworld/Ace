...
TRTDetectionPostProcess::TRTDetectionPostProcess(
...
std::vector<ITensor *> TRTDetectionPostProcess::onEncode(
...
TRTCreatorRegister<TypedCreator<TRTDetectionPostProcess>>
    __detection_post_process_op(OpType_DetectionPostProcess);
