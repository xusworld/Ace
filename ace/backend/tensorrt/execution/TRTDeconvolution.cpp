...
TRTDeconvolution::TRTDeconvolution(Backend *b, const Op *op,
                                   const std::vector<Tensor *> &inputs,
                                   const std::vector<Tensor *> &outputs)
    : ace::TRTCommonExecution(b, op) {}

std::vector<ITensor *> TRTDeconvolution::onEncode(
...
TRTCreatorRegister<TypedCreator<TRTDeconvolution>> __de_conv_op(
