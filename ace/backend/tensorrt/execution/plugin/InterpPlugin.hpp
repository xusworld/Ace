...
class InterpPlugin : public CommonPlugin::Enqueue {
 public:
  ...
  cudaError_t InterpExecute(nvinfer1::DataType dataType, const int count,
                            const float heightScale, const float widthScale,
                            const float heightOffset, const float widthOffset,
