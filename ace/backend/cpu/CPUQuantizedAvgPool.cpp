...
CPUQuantizedAvgPool::CPUQuantizedAvgPool(Backend *backend,
...
ErrorCode CPUQuantizedAvgPool::onResize(const std::vector<Tensor *> &inputs,
...
ErrorCode CPUQuantizedAvgPool::onExecute(const std::vector<Tensor *> &inputs,
                                         const std::vector<Tensor *> &outputs) {
