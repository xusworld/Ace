...
static void poolingMax(const T *channelInput, int inputWidth, int inputHeight,
                       ...
                       ace::PoolPadType padType,
                       ace::AvgPoolCountType countType) {
  // Compute Mid Rect
...
static void poolingAvgPad(const T *offsetInput, T *offsetOutput, int inputWidth,
                          ...
                          int padHeight, ace::PoolPadType padType,
                          ace::AvgPoolCountType countType) {
  VEC sum = VEC(0.0f);
  ...
  // sum
  int count = 0;
  if (countType == ace::AvgPoolCountType_DEFAULT) {
    if (padType == ace::PoolPadType_CAFFE) {
      countType = ace::AvgPoolCountType_INCLUDE_PADDING;
    } else {
      countType = ace::AvgPoolCountType_EXCLUDE_PADDING;
    }
  }
  if (countType == ace::AvgPoolCountType_INCLUDE_PADDING) {
