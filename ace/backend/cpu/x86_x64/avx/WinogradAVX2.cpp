...
void _AVX_WinogradInit(void* functions) {
  auto core = reinterpret_cast<ace::CoreFunctions*>(functions);
  core->chooseWinoDestTransform = ace::_AVX2_chooseDestTransform;
  core->chooseWinoSourceTransform = ace::_AVX2_chooseSourceTransform;
}
