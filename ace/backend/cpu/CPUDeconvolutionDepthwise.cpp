...
CPUDeconvolutionDepthwise::CPUDeconvolutionDepthwise(const Tensor* input,
                                                     const Op* convOp,
                                                     Backend* b)
    : ace::CPUDeconvolutionCommon(input, convOp, b) {
...
ErrorCode CPUDeconvolutionDepthwiseMultiInput::onResize(
...
ErrorCode CPUDeconvolutionDepthwiseMultiInput::onExecute(
    const std::vector<Tensor*>& inputs, const std::vector<Tensor*>& outputs) {
  auto core = static_cast<CPUBackend*>(backend())->functions();
...
ErrorCode CPUDeconvolutionDepthwiseBasic::onResize(
    const std::vector<Tensor*>& inputs, const std::vector<Tensor*>& outputs) {
...
ErrorCode CPUDeconvolutionDepthwiseBasic::onExecute(
    const std::vector<Tensor*>& inputs, const std::vector<Tensor*>& outputs) {
