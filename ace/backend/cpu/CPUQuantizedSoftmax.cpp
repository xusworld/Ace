...
template <typename T>
CPUQuantizedSoftmax<T>::CPUQuantizedSoftmax(Backend* backend, const Op* op)
    : Execution(backend) {
...
template <typename T>
ErrorCode CPUQuantizedSoftmax<T>::onResize(
...
template <typename T>
ErrorCode CPUQuantizedSoftmax<T>::onExecute(
