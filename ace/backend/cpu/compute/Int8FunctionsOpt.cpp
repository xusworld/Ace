...
static void _fastIm2Col(
    ...
    const ace::ConvolutionCommon::Im2ColParameter* im2colParameter,
...
static ace::CoreInt8Functions::Im2ColFunc chooseIm2Col(
    const ace::ConvolutionCommon::Im2ColParameter* im2colParam,
    size_t inputChannel) {
...
static void _im2colCommonSdot(
    int8_t* colAddr, const int8_t* src, int8_t inputZeroPoint,
    const ace::ConvolutionCommon::Im2ColParameter* im2colParameter,
    size_t xIndexStart, size_t realDstCount) {
...
static ace::CoreInt8Functions::Im2ColFunc chooseIm2ColSdot(
    const ace::ConvolutionCommon::Im2ColParameter* im2colParam,
    size_t inputChannel) {
  bool fastIm2Col = im2colParam->kernelX == 1 && im2colParam->kernelY == 1 &&
                    im2colParam->icDiv4 % 2 == 0 && im2colParam->strideX == 1 &&
