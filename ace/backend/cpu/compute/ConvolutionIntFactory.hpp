...
class ConvolutionIntFactory {
 public:
  static Execution* create(const Tensor* input, const Tensor* output,
                           const ace::Op* op, Backend* backend,
                           const ConvolutionCommon::Int8Common* common);

  static Execution* createUnit(const Tensor* input, const Tensor* output,
                               const ace::Op* op, Backend* bn,
                               const ConvolutionCommon::Int8Common* common,
