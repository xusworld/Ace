...
class WinogradInt8Helper {
 public:
  WinogradInt8Helper(int unitY, int unitX, const Convolution2DCommon* common,
  ...
  typedef void (*SrcTransFunc)(const int8_t* srcStart, int8_t* dstStart,
                               size_t srcZStep, size_t dstXStep,
                               size_t dstZStep, size_t countUnit);
  typedef void (*DstTransFunc)(const float* srcStart, float* dstStart,
  ...
  static bool weightOverflow(const Tensor* weightSrc, int unitY, int unitX,
