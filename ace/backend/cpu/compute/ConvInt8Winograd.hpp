...
class ConvInt8Winograd : public CPUConvolution {
 public:
  ...
  ConvInt8Winograd(Backend *b, const Convolution2D *convOp,
  ...
  static bool bestWinogradUnit(const Convolution2D *convOp, const Tensor *input,
                               const Tensor *weightSrc, const Tensor *output,
                               Backend *bn, std::vector<UnitAttr> &unitAttrs);
  virtual bool onClone(Backend *bn, const Op *op, Execution **dst) override;

 private:
  ConvInt8Winograd(Backend *backend, const Convolution2DCommon *common,
  ...
  class WinoExecution : public CPUConvolution {
   public:
    WinoExecution(Backend *b, const Convolution2DCommon *common, Tensor *weight,
                  int unitY, int unitX, bool fastgemm);

    WinoExecution(Backend *bn, const Convolution2DCommon *common,
  ...
  static bool chooseTransformFuncs(int kernelY, int kernelX, int unitY,
                                   int unitX,
                                   ConvInt8Winograd::WinoExecution *exe,
                                   Backend *bn);
};
}  // namespace ace
