...
namespace ace {
static void _sourceTransformUnit4x4(const int16_t* srcBlock, int16_t* dstStart,
...
static void _destTransformUnit4x2(const int16_t* srcBlock, int16_t* dstStart,
                                  size_t srcStep, size_t dstStep) {
  BFVec4 s0 = BFVec4::load(srcBlock + 0 * srcStep);
  BFVec4 s1 = BFVec4::load(srcBlock + 1 * srcStep);
  BFVec4 s2 = BFVec4::load(srcBlock + 2 * srcStep);
...
static void _destTransformUnit4x3(const int16_t* srcBlock, int16_t* dstStart,
                                  size_t srcStep, size_t dstStep) {
  BFVec4 s0 = BFVec4::load(srcBlock + 0 * srcStep);
  BFVec4 s1 = BFVec4::load(srcBlock + 1 * srcStep);
  BFVec4 s2 = BFVec4::load(srcBlock + 2 * srcStep);
...
static void _sourceTransformUnit6x6(const int16_t* srcBlock, int16_t* dstStart,
                                    size_t srcStep, size_t dstStep) {
  LOAD6;
...
static void _destTransformUnit6x5(const int16_t* srcBlock, int16_t* dstStart,
                                  size_t srcStep, size_t dstStep) {
  BFVec4 s0 = BFVec4::load(srcBlock + 0 * srcStep);
  BFVec4 s1 = BFVec4::load(srcBlock + 1 * srcStep);
  BFVec4 s2 = BFVec4::load(srcBlock + 2 * srcStep);
...
static void _destTransformUnit6x4(const int16_t* srcBlock, int16_t* dstStart,
                                  size_t srcStep, size_t dstStep) {
  BFVec4 s0 = BFVec4::load(srcBlock + 0 * srcStep);
  BFVec4 s1 = BFVec4::load(srcBlock + 1 * srcStep);
  BFVec4 s2 = BFVec4::load(srcBlock + 2 * srcStep);
...
static void _destTransformUnit6x3(const int16_t* srcBlock, int16_t* dstStart,
                                  size_t srcStep, size_t dstStep) {
  BFVec4 s0 = BFVec4::load(srcBlock + 0 * srcStep);
  BFVec4 s1 = BFVec4::load(srcBlock + 1 * srcStep);
  BFVec4 s2 = BFVec4::load(srcBlock + 2 * srcStep);
...
static void _destTransformUnit6x2(const int16_t* srcBlock, int16_t* dstStart,
                                  size_t srcStep, size_t dstStep) {
  BFVec4 s0 = BFVec4::load(srcBlock + 0 * srcStep);
  BFVec4 s1 = BFVec4::load(srcBlock + 1 * srcStep);
  BFVec4 s2 = BFVec4::load(srcBlock + 2 * srcStep);
...
WinogradFunctionHalf::TransformFunc WinogradFunctionHalf::chooseSourceTransform(
    int k, int w) {
  if (6 == k && 6 == w) {
...
WinogradFunctionHalf::TransformFunc WinogradFunctionHalf::chooseDestTransform(
    int k, int h) {
  if (6 == k) {
    if (h <= 1 || h > 5) {
      return nullptr;
