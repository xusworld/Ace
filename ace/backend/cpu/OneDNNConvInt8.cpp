...
Execution* OneDNNConvInt8::create(Backend* backend,
                                  const ace::Convolution2D* convParam,
...
OneDNNConvInt8::OneDNNConvInt8(
    std::shared_ptr<OneDNNConvInt8::Resource> resource,
    const ace::Convolution2DCommon* common, Backend* bn)
...
ErrorCode OneDNNConvInt8::onResize(const std::vector<Tensor*>& inputs,
                                   const std::vector<Tensor*>& outputs) {
...
ErrorCode OneDNNConvInt8::onExecute(const std::vector<Tensor*>& inputs,
                                    const std::vector<Tensor*>& outputs) {
