...
struct GreatherThanOption;
struct GreatherThanOptionT;
...
inline const flatbuffers::TypeTable *GreatherThanOptionTypeTable();
...
enum ElementwiseType {
  ElementwiseType_NONE = 0,
  ElementwiseType_AbsOption = 1,
  ElementwiseType_BoundedReluOption = 2,
  ElementwiseType_ClipOption = 3,
  ElementwiseType_ClipV2Option = 4,
  ElementwiseType_ClippedReluOption = 5,
  ElementwiseType_EluOption = 6,
  ElementwiseType_ExpOption = 7,
  ElementwiseType_GeluTanhOption = 8,
  ElementwiseType_HardSigmoidOption = 9,
  ElementwiseType_HardSwishOption = 10,
  ElementwiseType_LeakyReluOption = 11,
  ElementwiseType_LinearOption = 12,
  ElementwiseType_LogOption = 13,
  ElementwiseType_LogisticOption = 14,
  ElementwiseType_LogSigmoidOption = 15,
  ElementwiseType_MishOption = 16,
  ElementwiseType_PowOption = 17,
  ElementwiseType_PReluOption = 18,
  ElementwiseType_ReluOption = 19,
  ElementwiseType_Relu6Option = 20,
  ElementwiseType_RoundOption = 21,
  ElementwiseType_SeluOption = 22,
  ElementwiseType_SigmoidOption = 23,
  ElementwiseType_SoftReluOption = 24,
  ElementwiseType_SoftReluV2Option = 25,
  ElementwiseType_SqrtOption = 26,
  ElementwiseType_SwishOption = 27,
  ElementwiseType_TanhOption = 28,
  ElementwiseType_NoneElementwiseOption = 29,
  ElementwiseType_MIN = ElementwiseType_NONE,
  ElementwiseType_MAX = ElementwiseType_NoneElementwiseOption
};

inline const ElementwiseType (&EnumValuesElementwiseType())[30] {
  static const ElementwiseType values[] = {
    ElementwiseType_NONE,
    ElementwiseType_AbsOption,
    ElementwiseType_BoundedReluOption,
    ElementwiseType_ClipOption,
    ElementwiseType_ClipV2Option,
    ElementwiseType_ClippedReluOption,
    ElementwiseType_EluOption,
    ElementwiseType_ExpOption,
    ElementwiseType_GeluTanhOption,
    ElementwiseType_HardSigmoidOption,
    ElementwiseType_HardSwishOption,
    ElementwiseType_LeakyReluOption,
    ElementwiseType_LinearOption,
    ElementwiseType_LogOption,
    ElementwiseType_LogisticOption,
    ElementwiseType_LogSigmoidOption,
    ElementwiseType_MishOption,
    ElementwiseType_PowOption,
    ElementwiseType_PReluOption,
    ElementwiseType_ReluOption,
    ElementwiseType_Relu6Option,
    ElementwiseType_RoundOption,
    ElementwiseType_SeluOption,
    ElementwiseType_SigmoidOption,
    ElementwiseType_SoftReluOption,
    ElementwiseType_SoftReluV2Option,
    ElementwiseType_SqrtOption,
    ElementwiseType_SwishOption,
    ElementwiseType_TanhOption,
    ElementwiseType_NoneElementwiseOption
  };
  return values;
}

inline const char * const *EnumNamesElementwiseType() {
...
inline const char *EnumNameElementwiseType(ElementwiseType e) {
  if (e < ElementwiseType_NONE || e > ElementwiseType_NoneElementwiseOption) return "";
  const size_t index = static_cast<int>(e);
  return EnumNamesElementwiseType()[index];
}

template<typename T> struct ElementwiseTypeTraits {
  static const ElementwiseType enum_value = ElementwiseType_NONE;
};

template<> struct ElementwiseTypeTraits<AbsOption> {
  static const ElementwiseType enum_value = ElementwiseType_AbsOption;
};

template<> struct ElementwiseTypeTraits<BoundedReluOption> {
  static const ElementwiseType enum_value = ElementwiseType_BoundedReluOption;
};

template<> struct ElementwiseTypeTraits<ClipOption> {
  static const ElementwiseType enum_value = ElementwiseType_ClipOption;
};

template<> struct ElementwiseTypeTraits<ClipV2Option> {
  static const ElementwiseType enum_value = ElementwiseType_ClipV2Option;
};

template<> struct ElementwiseTypeTraits<ClippedReluOption> {
  static const ElementwiseType enum_value = ElementwiseType_ClippedReluOption;
};

template<> struct ElementwiseTypeTraits<EluOption> {
  static const ElementwiseType enum_value = ElementwiseType_EluOption;
};

template<> struct ElementwiseTypeTraits<ExpOption> {
  static const ElementwiseType enum_value = ElementwiseType_ExpOption;
};

template<> struct ElementwiseTypeTraits<GeluTanhOption> {
  static const ElementwiseType enum_value = ElementwiseType_GeluTanhOption;
};

template<> struct ElementwiseTypeTraits<HardSigmoidOption> {
  static const ElementwiseType enum_value = ElementwiseType_HardSigmoidOption;
};

template<> struct ElementwiseTypeTraits<HardSwishOption> {
  static const ElementwiseType enum_value = ElementwiseType_HardSwishOption;
};

template<> struct ElementwiseTypeTraits<LeakyReluOption> {
  static const ElementwiseType enum_value = ElementwiseType_LeakyReluOption;
};

template<> struct ElementwiseTypeTraits<LinearOption> {
  static const ElementwiseType enum_value = ElementwiseType_LinearOption;
};

template<> struct ElementwiseTypeTraits<LogOption> {
  static const ElementwiseType enum_value = ElementwiseType_LogOption;
};

template<> struct ElementwiseTypeTraits<LogisticOption> {
  static const ElementwiseType enum_value = ElementwiseType_LogisticOption;
};

template<> struct ElementwiseTypeTraits<LogSigmoidOption> {
  static const ElementwiseType enum_value = ElementwiseType_LogSigmoidOption;
};

template<> struct ElementwiseTypeTraits<MishOption> {
  static const ElementwiseType enum_value = ElementwiseType_MishOption;
};

template<> struct ElementwiseTypeTraits<PowOption> {
  static const ElementwiseType enum_value = ElementwiseType_PowOption;
};

template<> struct ElementwiseTypeTraits<PReluOption> {
  static const ElementwiseType enum_value = ElementwiseType_PReluOption;
};

template<> struct ElementwiseTypeTraits<ReluOption> {
  static const ElementwiseType enum_value = ElementwiseType_ReluOption;
};

template<> struct ElementwiseTypeTraits<Relu6Option> {
  static const ElementwiseType enum_value = ElementwiseType_Relu6Option;
};

template<> struct ElementwiseTypeTraits<RoundOption> {
  static const ElementwiseType enum_value = ElementwiseType_RoundOption;
};

template<> struct ElementwiseTypeTraits<SeluOption> {
  static const ElementwiseType enum_value = ElementwiseType_SeluOption;
};

template<> struct ElementwiseTypeTraits<SigmoidOption> {
  static const ElementwiseType enum_value = ElementwiseType_SigmoidOption;
};

template<> struct ElementwiseTypeTraits<SoftReluOption> {
  static const ElementwiseType enum_value = ElementwiseType_SoftReluOption;
};

template<> struct ElementwiseTypeTraits<SoftReluV2Option> {
  static const ElementwiseType enum_value = ElementwiseType_SoftReluV2Option;
};

template<> struct ElementwiseTypeTraits<SqrtOption> {
  static const ElementwiseType enum_value = ElementwiseType_SqrtOption;
};

template<> struct ElementwiseTypeTraits<SwishOption> {
  static const ElementwiseType enum_value = ElementwiseType_SwishOption;
};

template<> struct ElementwiseTypeTraits<TanhOption> {
  static const ElementwiseType enum_value = ElementwiseType_TanhOption;
};

template<> struct ElementwiseTypeTraits<NoneElementwiseOption> {
  static const ElementwiseType enum_value = ElementwiseType_NoneElementwiseOption;
};

struct ElementwiseTypeUnion {
  ElementwiseType type;
  void *value;

  ElementwiseTypeUnion() : type(ElementwiseType_NONE), value(nullptr) {}
  ElementwiseTypeUnion(ElementwiseTypeUnion&& u) FLATBUFFERS_NOEXCEPT :
    type(ElementwiseType_NONE), value(nullptr)
    { std::swap(type, u.type); std::swap(value, u.value); }
  ElementwiseTypeUnion(const ElementwiseTypeUnion &) FLATBUFFERS_NOEXCEPT;
  ElementwiseTypeUnion &operator=(const ElementwiseTypeUnion &u) FLATBUFFERS_NOEXCEPT
    { ElementwiseTypeUnion t(u); std::swap(type, t.type); std::swap(value, t.value); return *this; }
  ElementwiseTypeUnion &operator=(ElementwiseTypeUnion &&u) FLATBUFFERS_NOEXCEPT
    { std::swap(type, u.type); std::swap(value, u.value); return *this; }
  ~ElementwiseTypeUnion() { Reset(); }
  ...
  void Set(T&& val) {
    Reset();
    type = ElementwiseTypeTraits<typename T::TableType>::enum_value;
    if (type != ElementwiseType_NONE) {
      value = new T(std::forward<T>(val));
    }
  }
#endif  // FLATBUFFERS_CPP98_STL

  static void *UnPack(const void *obj, ElementwiseType type, const flatbuffers::resolver_function_t *resolver);
  flatbuffers::Offset<void> Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher = nullptr) const;

  AbsOptionT *AsAbsOption() {
    return type == ElementwiseType_AbsOption ?
  ...
  BoundedReluOptionT *AsBoundedReluOption() {
    return type == ElementwiseType_BoundedReluOption ?
  ...
  ClipOptionT *AsClipOption() {
    return type == ElementwiseType_ClipOption ?
  ...
  ClipV2OptionT *AsClipV2Option() {
    return type == ElementwiseType_ClipV2Option ?
  ...
  ClippedReluOptionT *AsClippedReluOption() {
    return type == ElementwiseType_ClippedReluOption ?
  ...
  EluOptionT *AsEluOption() {
    return type == ElementwiseType_EluOption ?
  ...
  ExpOptionT *AsExpOption() {
    return type == ElementwiseType_ExpOption ?
  ...
  GeluTanhOptionT *AsGeluTanhOption() {
    return type == ElementwiseType_GeluTanhOption ?
  ...
  HardSigmoidOptionT *AsHardSigmoidOption() {
    return type == ElementwiseType_HardSigmoidOption ?
  ...
  HardSwishOptionT *AsHardSwishOption() {
    return type == ElementwiseType_HardSwishOption ?
  ...
  LeakyReluOptionT *AsLeakyReluOption() {
    return type == ElementwiseType_LeakyReluOption ?
  ...
  LinearOptionT *AsLinearOption() {
    return type == ElementwiseType_LinearOption ?
  ...
  LogOptionT *AsLogOption() {
    return type == ElementwiseType_LogOption ?
  ...
  LogisticOptionT *AsLogisticOption() {
    return type == ElementwiseType_LogisticOption ?
  ...
  LogSigmoidOptionT *AsLogSigmoidOption() {
    return type == ElementwiseType_LogSigmoidOption ?
  ...
  MishOptionT *AsMishOption() {
    return type == ElementwiseType_MishOption ?
  ...
  PowOptionT *AsPowOption() {
    return type == ElementwiseType_PowOption ?
  ...
  PReluOptionT *AsPReluOption() {
    return type == ElementwiseType_PReluOption ?
  ...
  ReluOptionT *AsReluOption() {
    return type == ElementwiseType_ReluOption ?
  ...
  Relu6OptionT *AsRelu6Option() {
    return type == ElementwiseType_Relu6Option ?
  ...
  RoundOptionT *AsRoundOption() {
    return type == ElementwiseType_RoundOption ?
  ...
  SeluOptionT *AsSeluOption() {
    return type == ElementwiseType_SeluOption ?
  ...
  SigmoidOptionT *AsSigmoidOption() {
    return type == ElementwiseType_SigmoidOption ?
  ...
  SoftReluOptionT *AsSoftReluOption() {
    return type == ElementwiseType_SoftReluOption ?
  ...
  SoftReluV2OptionT *AsSoftReluV2Option() {
    return type == ElementwiseType_SoftReluV2Option ?
  ...
  SqrtOptionT *AsSqrtOption() {
    return type == ElementwiseType_SqrtOption ?
  ...
  SwishOptionT *AsSwishOption() {
    return type == ElementwiseType_SwishOption ?
  ...
  TanhOptionT *AsTanhOption() {
    return type == ElementwiseType_TanhOption ?
  ...
  NoneElementwiseOptionT *AsNoneElementwiseOption() {
    return type == ElementwiseType_NoneElementwiseOption ?
...
bool VerifyElementwiseType(flatbuffers::Verifier &verifier, const void *obj, ElementwiseType type);
bool VerifyElementwiseTypeVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types);

enum BinaryType {
  BinaryType_NONE = 0,
  BinaryType_AddOption = 1,
  BinaryType_MulOption = 2,
  BinaryType_MinOption = 3,
  BinaryType_MaxOption = 4,
  BinaryType_MeanOption = 5,
  BinaryType_DivOption = 6,
  BinaryType_GreaterEqualOption = 7,
  BinaryType_GreatherThanOption = 8,
  BinaryType_LessEqualOption = 9,
  BinaryType_LessThanOption = 10,
  BinaryType_EqualToOption = 11,
  BinaryType_NotEqualOption = 12,
  BinaryType_MIN = BinaryType_NONE,
  BinaryType_MAX = BinaryType_NotEqualOption
};

inline const BinaryType (&EnumValuesBinaryType())[13] {
  static const BinaryType values[] = {
    BinaryType_NONE,
    BinaryType_AddOption,
    BinaryType_MulOption,
    BinaryType_MinOption,
    BinaryType_MaxOption,
    BinaryType_MeanOption,
    BinaryType_DivOption,
    BinaryType_GreaterEqualOption,
    BinaryType_GreatherThanOption,
    BinaryType_LessEqualOption,
    BinaryType_LessThanOption,
    BinaryType_EqualToOption,
    BinaryType_NotEqualOption
  };
  return values;
}
...
inline const char *EnumNameBinaryType(BinaryType e) {
  if (e < BinaryType_NONE || e > BinaryType_NotEqualOption) return "";
  const size_t index = static_cast<int>(e);
  return EnumNamesBinaryType()[index];
}

template<typename T> struct BinaryTypeTraits {
  static const BinaryType enum_value = BinaryType_NONE;
};

template<> struct BinaryTypeTraits<AddOption> {
  static const BinaryType enum_value = BinaryType_AddOption;
};

template<> struct BinaryTypeTraits<MulOption> {
  static const BinaryType enum_value = BinaryType_MulOption;
};

template<> struct BinaryTypeTraits<MinOption> {
  static const BinaryType enum_value = BinaryType_MinOption;
};

template<> struct BinaryTypeTraits<MaxOption> {
  static const BinaryType enum_value = BinaryType_MaxOption;
};

template<> struct BinaryTypeTraits<MeanOption> {
  static const BinaryType enum_value = BinaryType_MeanOption;
};

template<> struct BinaryTypeTraits<DivOption> {
  static const BinaryType enum_value = BinaryType_DivOption;
};

template<> struct BinaryTypeTraits<GreaterEqualOption> {
  static const BinaryType enum_value = BinaryType_GreaterEqualOption;
};

template<> struct BinaryTypeTraits<GreatherThanOption> {
  static const BinaryType enum_value = BinaryType_GreatherThanOption;
};

template<> struct BinaryTypeTraits<LessEqualOption> {
  static const BinaryType enum_value = BinaryType_LessEqualOption;
};

template<> struct BinaryTypeTraits<LessThanOption> {
  static const BinaryType enum_value = BinaryType_LessThanOption;
};

template<> struct BinaryTypeTraits<EqualToOption> {
  static const BinaryType enum_value = BinaryType_EqualToOption;
};

template<> struct BinaryTypeTraits<NotEqualOption> {
  static const BinaryType enum_value = BinaryType_NotEqualOption;
};

struct BinaryTypeUnion {
  BinaryType type;
  void *value;

  BinaryTypeUnion() : type(BinaryType_NONE), value(nullptr) {}
  BinaryTypeUnion(BinaryTypeUnion&& u) FLATBUFFERS_NOEXCEPT :
    type(BinaryType_NONE), value(nullptr)
    { std::swap(type, u.type); std::swap(value, u.value); }
  BinaryTypeUnion(const BinaryTypeUnion &) FLATBUFFERS_NOEXCEPT;
  BinaryTypeUnion &operator=(const BinaryTypeUnion &u) FLATBUFFERS_NOEXCEPT
    { BinaryTypeUnion t(u); std::swap(type, t.type); std::swap(value, t.value); return *this; }
  BinaryTypeUnion &operator=(BinaryTypeUnion &&u) FLATBUFFERS_NOEXCEPT
    { std::swap(type, u.type); std::swap(value, u.value); return *this; }
  ~BinaryTypeUnion() { Reset(); }
  ...
  void Set(T&& val) {
    Reset();
    type = BinaryTypeTraits<typename T::TableType>::enum_value;
    if (type != BinaryType_NONE) {
      value = new T(std::forward<T>(val));
    }
  }
#endif  // FLATBUFFERS_CPP98_STL

  static void *UnPack(const void *obj, BinaryType type, const flatbuffers::resolver_function_t *resolver);
  flatbuffers::Offset<void> Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher = nullptr) const;

  AddOptionT *AsAddOption() {
    return type == BinaryType_AddOption ?
  ...
  MulOptionT *AsMulOption() {
    return type == BinaryType_MulOption ?
  ...
  MinOptionT *AsMinOption() {
    return type == BinaryType_MinOption ?
  ...
  MaxOptionT *AsMaxOption() {
    return type == BinaryType_MaxOption ?
  ...
  MeanOptionT *AsMeanOption() {
    return type == BinaryType_MeanOption ?
  ...
  DivOptionT *AsDivOption() {
    return type == BinaryType_DivOption ?
  ...
  GreaterEqualOptionT *AsGreaterEqualOption() {
    return type == BinaryType_GreaterEqualOption ?
  ...
  GreatherThanOptionT *AsGreatherThanOption() {
    return type == BinaryType_GreatherThanOption ?
      reinterpret_cast<GreatherThanOptionT *>(value) : nullptr;
  }
  const GreatherThanOptionT *AsGreatherThanOption() const {
    return type == BinaryType_GreatherThanOption ?
      reinterpret_cast<const GreatherThanOptionT *>(value) : nullptr;
  }
  LessEqualOptionT *AsLessEqualOption() {
    return type == BinaryType_LessEqualOption ?
  ...
  LessThanOptionT *AsLessThanOption() {
    return type == BinaryType_LessThanOption ?
  ...
  EqualToOptionT *AsEqualToOption() {
    return type == BinaryType_EqualToOption ?
  ...
  NotEqualOptionT *AsNotEqualOption() {
    return type == BinaryType_NotEqualOption ?
...
bool VerifyBinaryType(flatbuffers::Verifier &verifier, const void *obj, BinaryType type);
bool VerifyBinaryTypeVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types);

enum ReduceType {
  ReduceType_NONE = 0,
  ReduceType_ReduceMinOption = 1,
  ReduceType_ReduceMaxOption = 2,
  ReduceType_ReduceMeanOption = 3,
  ReduceType_ReduceSumOption = 4,
  ReduceType_ReduceMulOption = 5,
  ReduceType_MIN = ReduceType_NONE,
  ReduceType_MAX = ReduceType_ReduceMulOption
};

inline const ReduceType (&EnumValuesReduceType())[6] {
  static const ReduceType values[] = {
    ReduceType_NONE,
    ReduceType_ReduceMinOption,
    ReduceType_ReduceMaxOption,
    ReduceType_ReduceMeanOption,
    ReduceType_ReduceSumOption,
    ReduceType_ReduceMulOption
  };
  return values;
}
...
inline const char *EnumNameReduceType(ReduceType e) {
  if (e < ReduceType_NONE || e > ReduceType_ReduceMulOption) return "";
  const size_t index = static_cast<int>(e);
  return EnumNamesReduceType()[index];
}

template<typename T> struct ReduceTypeTraits {
  static const ReduceType enum_value = ReduceType_NONE;
};

template<> struct ReduceTypeTraits<ReduceMinOption> {
  static const ReduceType enum_value = ReduceType_ReduceMinOption;
};

template<> struct ReduceTypeTraits<ReduceMaxOption> {
  static const ReduceType enum_value = ReduceType_ReduceMaxOption;
};

template<> struct ReduceTypeTraits<ReduceMeanOption> {
  static const ReduceType enum_value = ReduceType_ReduceMeanOption;
};

template<> struct ReduceTypeTraits<ReduceSumOption> {
  static const ReduceType enum_value = ReduceType_ReduceSumOption;
};

template<> struct ReduceTypeTraits<ReduceMulOption> {
  static const ReduceType enum_value = ReduceType_ReduceMulOption;
};

struct ReduceTypeUnion {
  ReduceType type;
  void *value;

  ReduceTypeUnion() : type(ReduceType_NONE), value(nullptr) {}
  ReduceTypeUnion(ReduceTypeUnion&& u) FLATBUFFERS_NOEXCEPT :
    type(ReduceType_NONE), value(nullptr)
    { std::swap(type, u.type); std::swap(value, u.value); }
  ReduceTypeUnion(const ReduceTypeUnion &) FLATBUFFERS_NOEXCEPT;
  ReduceTypeUnion &operator=(const ReduceTypeUnion &u) FLATBUFFERS_NOEXCEPT
    { ReduceTypeUnion t(u); std::swap(type, t.type); std::swap(value, t.value); return *this; }
  ReduceTypeUnion &operator=(ReduceTypeUnion &&u) FLATBUFFERS_NOEXCEPT
    { std::swap(type, u.type); std::swap(value, u.value); return *this; }
  ~ReduceTypeUnion() { Reset(); }
  ...
  void Set(T&& val) {
    Reset();
    type = ReduceTypeTraits<typename T::TableType>::enum_value;
    if (type != ReduceType_NONE) {
      value = new T(std::forward<T>(val));
    }
  }
#endif  // FLATBUFFERS_CPP98_STL

  static void *UnPack(const void *obj, ReduceType type, const flatbuffers::resolver_function_t *resolver);
  flatbuffers::Offset<void> Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher = nullptr) const;

  ReduceMinOptionT *AsReduceMinOption() {
    return type == ReduceType_ReduceMinOption ?
  ...
  ReduceMaxOptionT *AsReduceMaxOption() {
    return type == ReduceType_ReduceMaxOption ?
  ...
  ReduceMeanOptionT *AsReduceMeanOption() {
    return type == ReduceType_ReduceMeanOption ?
  ...
  ReduceSumOptionT *AsReduceSumOption() {
    return type == ReduceType_ReduceSumOption ?
  ...
  ReduceMulOptionT *AsReduceMulOption() {
    return type == ReduceType_ReduceMulOption ?
...
bool VerifyReduceType(flatbuffers::Verifier &verifier, const void *obj, ReduceType type);
bool VerifyReduceTypeVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types);
...
enum OpOption {
  ...
  OpOption_GreatherThanOption = 38,
...
template<> struct OpOptionTraits<GreatherThanOption> {
  static const OpOption enum_value = OpOption_GreatherThanOption;
};
...
struct OpOptionUnion {
  ...
  GreatherThanOptionT *AsGreatherThanOption() {
    return type == OpOption_GreatherThanOption ?
      reinterpret_cast<GreatherThanOptionT *>(value) : nullptr;
  }
  const GreatherThanOptionT *AsGreatherThanOption() const {
    return type == OpOption_GreatherThanOption ?
...
struct GreatherThanOptionT : public flatbuffers::NativeTable {
  typedef GreatherThanOption TableType;
  GreatherThanOptionT() {
  }
};

struct GreatherThanOption FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef GreatherThanOptionT NativeTableType;
  static const flatbuffers::TypeTable *MiniReflectTypeTable() {
    return GreatherThanOptionTypeTable();
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           verifier.EndTable();
  }
  GreatherThanOptionT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(GreatherThanOptionT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<GreatherThanOption> Pack(flatbuffers::FlatBufferBuilder &_fbb, const GreatherThanOptionT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct GreatherThanOptionBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  explicit GreatherThanOptionBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  GreatherThanOptionBuilder &operator=(const GreatherThanOptionBuilder &);
  flatbuffers::Offset<GreatherThanOption> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<GreatherThanOption>(end);
    return o;
  }
};

inline flatbuffers::Offset<GreatherThanOption> CreateGreatherThanOption(
    flatbuffers::FlatBufferBuilder &_fbb) {
  GreatherThanOptionBuilder builder_(_fbb);
  return builder_.Finish();
}

flatbuffers::Offset<GreatherThanOption> CreateGreatherThanOption(flatbuffers::FlatBufferBuilder &_fbb, const GreatherThanOptionT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline GreatherThanOptionT *GreatherThanOption::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = new GreatherThanOptionT();
  UnPackTo(_o, _resolver);
  return _o;
}

inline void GreatherThanOption::UnPackTo(GreatherThanOptionT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
}

inline flatbuffers::Offset<GreatherThanOption> GreatherThanOption::Pack(flatbuffers::FlatBufferBuilder &_fbb, const GreatherThanOptionT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateGreatherThanOption(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<GreatherThanOption> CreateGreatherThanOption(flatbuffers::FlatBufferBuilder &_fbb, const GreatherThanOptionT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GreatherThanOptionT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  return ace::CreateGreatherThanOption(
      _fbb);
}
...
inline bool VerifyElementwiseTypeVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyElementwiseType(
        verifier,  values->Get(i), types->GetEnum<ElementwiseType>(i))) {
      return false;
    }
  }
  return true;
...
inline void *ElementwiseTypeUnion::UnPack(const void *obj, ElementwiseType type, const flatbuffers::resolver_function_t *resolver) {
  switch (type) {
    case ElementwiseType_AbsOption: {
      auto ptr = reinterpret_cast<const AbsOption *>(obj);
...
inline flatbuffers::Offset<void> ElementwiseTypeUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case ElementwiseType_AbsOption: {
...
inline ElementwiseTypeUnion::ElementwiseTypeUnion(const ElementwiseTypeUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case ElementwiseType_AbsOption: {
...
inline void ElementwiseTypeUnion::Reset() {
  switch (type) {
    case ElementwiseType_AbsOption: {
  ...
  value = nullptr;
  type = ElementwiseType_NONE;
}

inline bool VerifyBinaryType(flatbuffers::Verifier &verifier, const void *obj, BinaryType type) {
  switch (type) {
    case BinaryType_NONE: {
      return true;
    }
    case BinaryType_AddOption: {
      auto ptr = reinterpret_cast<const AddOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_MulOption: {
      auto ptr = reinterpret_cast<const MulOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_MinOption: {
      auto ptr = reinterpret_cast<const MinOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_MaxOption: {
      auto ptr = reinterpret_cast<const MaxOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_MeanOption: {
      auto ptr = reinterpret_cast<const MeanOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_DivOption: {
      auto ptr = reinterpret_cast<const DivOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_GreaterEqualOption: {
      auto ptr = reinterpret_cast<const GreaterEqualOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_GreatherThanOption: {
      auto ptr = reinterpret_cast<const GreatherThanOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_LessEqualOption: {
      auto ptr = reinterpret_cast<const LessEqualOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_LessThanOption: {
      auto ptr = reinterpret_cast<const LessThanOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_EqualToOption: {
      auto ptr = reinterpret_cast<const EqualToOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BinaryType_NotEqualOption: {
...
inline bool VerifyBinaryTypeVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyBinaryType(
        verifier,  values->Get(i), types->GetEnum<BinaryType>(i))) {
      return false;
    }
  }
  return true;
...
inline void *BinaryTypeUnion::UnPack(const void *obj, BinaryType type, const flatbuffers::resolver_function_t *resolver) {
  switch (type) {
    case BinaryType_AddOption: {
      auto ptr = reinterpret_cast<const AddOption *>(obj);
      return ptr->UnPack(resolver);
...
inline flatbuffers::Offset<void> BinaryTypeUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case BinaryType_AddOption: {
    ...
    case BinaryType_GreatherThanOption: {
      auto ptr = reinterpret_cast<const GreatherThanOptionT *>(value);
      return CreateGreatherThanOption(_fbb, ptr, _rehasher).Union();
    }
    case BinaryType_LessEqualOption: {
...
inline BinaryTypeUnion::BinaryTypeUnion(const BinaryTypeUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case BinaryType_AddOption: {
    ...
    case BinaryType_GreatherThanOption: {
      value = new GreatherThanOptionT(*reinterpret_cast<GreatherThanOptionT *>(u.value));
      break;
    }
    case BinaryType_LessEqualOption: {
...
inline void BinaryTypeUnion::Reset() {
  switch (type) {
    case BinaryType_AddOption: {
    ...
    case BinaryType_GreatherThanOption: {
      auto ptr = reinterpret_cast<GreatherThanOptionT *>(value);
      delete ptr;
      break;
    }
    case BinaryType_LessEqualOption: {
  ...
  value = nullptr;
  type = BinaryType_NONE;
}

inline bool VerifyReduceType(flatbuffers::Verifier &verifier, const void *obj, ReduceType type) {
  switch (type) {
    case ReduceType_NONE: {
      return true;
    }
    case ReduceType_ReduceMinOption: {
      auto ptr = reinterpret_cast<const ReduceMinOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ReduceType_ReduceMaxOption: {
      auto ptr = reinterpret_cast<const ReduceMaxOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ReduceType_ReduceMeanOption: {
      auto ptr = reinterpret_cast<const ReduceMeanOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ReduceType_ReduceSumOption: {
      auto ptr = reinterpret_cast<const ReduceSumOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ReduceType_ReduceMulOption: {
...
inline bool VerifyReduceTypeVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyReduceType(
        verifier,  values->Get(i), types->GetEnum<ReduceType>(i))) {
      return false;
    }
  }
  return true;
...
inline void *ReduceTypeUnion::UnPack(const void *obj, ReduceType type, const flatbuffers::resolver_function_t *resolver) {
  switch (type) {
    case ReduceType_ReduceMinOption: {
      auto ptr = reinterpret_cast<const ReduceMinOption *>(obj);
      return ptr->UnPack(resolver);
...
inline flatbuffers::Offset<void> ReduceTypeUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case ReduceType_ReduceMinOption: {
...
inline ReduceTypeUnion::ReduceTypeUnion(const ReduceTypeUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case ReduceType_ReduceMinOption: {
...
inline void ReduceTypeUnion::Reset() {
  switch (type) {
    case ReduceType_ReduceMinOption: {
...
inline bool VerifyOpOption(flatbuffers::Verifier &verifier, const void *obj, OpOption type) {
  switch (type) {
    ...
    case OpOption_GreatherThanOption: {
      auto ptr = reinterpret_cast<const GreatherThanOption *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline OpOptionUnion::OpOptionUnion(const OpOptionUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case OpOption_DefaultOption: {
      value = new DefaultOptionT(*reinterpret_cast<DefaultOptionT *>(u.value));
      break;
    }
    case OpOption_ConstOption: {
...
inline const flatbuffers::TypeTable *ElementwiseTypeTypeTable() {
...
inline const flatbuffers::TypeTable *BinaryTypeTypeTable() {
  static const flatbuffers::TypeCode type_codes[] = {
    { flatbuffers::ET_SEQUENCE, 0, -1 },
    { flatbuffers::ET_SEQUENCE, 0, 0 },
    { flatbuffers::ET_SEQUENCE, 0, 1 },
