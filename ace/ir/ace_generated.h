...
struct OpT : public flatbuffers::NativeTable {
  ...
  std::vector<int32_t> outputIndexes;
  OpType type;
  DATA_FORMAT defaultDimentionFormat;
  OpT()
      : type(OpType_AbsVal),
        defaultDimentionFormat(DATA_FORMAT_NHWC) {
  }
};
...
struct Op FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  DATA_FORMAT defaultDimentionFormat() const {
    return static_cast<DATA_FORMAT>(GetField<int8_t>(16, 1));
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, 4) &&
...
struct OpBuilder {
  ...
  void add_defaultDimentionFormat(DATA_FORMAT defaultDimentionFormat) {
...
inline flatbuffers::Offset<Op> CreateOp(
    ...
    DATA_FORMAT defaultDimentionFormat = DATA_FORMAT_NHWC) {
