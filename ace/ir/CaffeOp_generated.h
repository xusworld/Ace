...
struct Input FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  DATA_FORMAT dformat() const {
    return static_cast<DATA_FORMAT>(GetField<int8_t>(8, 2));
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, 4) &&
...
struct InputBuilder {
  ...
  void add_dformat(DATA_FORMAT dformat) {
...
inline flatbuffers::Offset<Input> CreateInput(
    ...
    DATA_FORMAT dformat = DATA_FORMAT_NC4HW4) {
...
struct ReshapeBuilder {
  ...
  void add_dimType(DATA_FORMAT dimType) {
...
inline flatbuffers::Offset<Reshape> CreateReshape(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<int32_t>> dims = 0,
    DATA_FORMAT dimType = DATA_FORMAT_NCHW) {
