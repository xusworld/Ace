...
inline void formatPrint(const char* prefix, const float& value,
                        const char* suffix) {
  MNN_PRINT("%s%f%s", prefix, value, suffix);
}
inline void formatPrint(const char* prefix, const double& value,
                        const char* suffix) {
  MNN_PRINT("%s%f%s", prefix, value, suffix);
}

inline void formatPrint(const char* prefix, const int16_t& value,
                        const char* suffix) {
  MNN_PRINT("%s%f%s", prefix, MNNBF16ToFP32(value), suffix);
}

inline void formatPrint(const char* prefix, const int& value,
                        const char* suffix) {
  MNN_PRINT("%s%d%s", prefix, value, suffix);
}
inline void formatPrint(const char* prefix, const unsigned int& value,
                        const char* suffix) {
  MNN_PRINT("%s%u%s", prefix, value, suffix);
}
inline void formatPrint(const char* prefix, const long int& value,
                        const char* suffix) {
  MNN_PRINT("%s%ld%s", prefix, value, suffix);
}
inline void formatPrint(const char* prefix, const unsigned long& value,
                        const char* suffix) {
  MNN_PRINT("%s%lu%s", prefix, value, suffix);
}

inline void formatPrint(const char* prefix, const long long& value,
                        const char* suffix) {
  MNN_PRINT("%s%lld%s", prefix, value, suffix);
}
inline void formatPrint(const char* prefix, const unsigned long long& value,
                        const char* suffix) {
