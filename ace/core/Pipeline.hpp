...
class Pipeline : public NonCopyable {
 public:
  Pipeline(std::vector<Schedule::PipelineInfo>&& info,
           std::shared_ptr<Backend> major, std::shared_ptr<Backend> backup,
           bool allocInput, Runtime::CompilerType compilerType);
  ~Pipeline();
