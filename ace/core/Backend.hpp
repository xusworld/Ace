...
class Backend : public NonCopyable {
 ...
 public:
   ...
   */
  Backend(DeviceType type) : mType(type) {
    // nothing to do
  }
 ...
 public:
   ...
   */
  virtual halide_type_t getRunType(const ace::Op* op, halide_type_t qtype,
                                   halide_type_t rtype) {
    return rtype;
  }
 ...
 public:
   ...
   * @return forward type.
   */
  inline DeviceType type() const { return mType; }
...
class Runtime : public NonCopyable {
 public:
  ...
  virtual bool onSetCache(const void* buffer, size_t size) { return false; }
 ...
 */
MNN_PUBLIC const RuntimeCreator* MNNGetExtraRuntimeCreator(DeviceType type);
 ...
 */
MNN_PUBLIC bool MNNInsertExtraRuntimeCreator(DeviceType type,
